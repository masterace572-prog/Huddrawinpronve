...
// Function Addons.AIMob_NTFox.SetStance
struct AAIMob_NTFox_SetStance_Params
{
	EFoxStance NewStance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.SetGait
struct AAIMob_NTFox_SetGait_Params
{
	ENTFoxGait NewGait; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.RequestTurnToRotation
struct AAIMob_NTFox_RequestTurnToRotation_Params
{
	struct FRotator TargetRotator; // (Parm, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.RequestTurnToPosition
struct AAIMob_NTFox_RequestTurnToPosition_Params
{
	struct FVector TargetPosition; // (Parm, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.RequestCurveTurn
struct AAIMob_NTFox_RequestCurveTurn_Params
{
	struct FRotator TargetRotator; // (Parm, IsPlainOldData)
	float TurnDuration; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.PlayMontage
struct AAIMob_NTFox_PlayMontage_Params
{
	class UAnimMontage* InMontage; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.OnRep_Stance
struct AAIMob_NTFox_OnRep_Stance_Params
{
	EFoxStance OldStance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.OnRep_Gait
struct AAIMob_NTFox_OnRep_Gait_Params
{
	ENTFoxGait OldGait; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.Multicast_RequestTurn
struct AAIMob_NTFox_Multicast_RequestTurn_Params
{
	struct FRotator TargetRotator; // (Parm, IsPlainOldData)
	float Duration; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.Multicast_RequestCurveTurn
struct AAIMob_NTFox_Multicast_RequestCurveTurn_Params
{
	struct FRotator TargetRotator; // (Parm, IsPlainOldData)
	float TurnDuration; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.Multicast_PlayMontage
struct AAIMob_NTFox_Multicast_PlayMontage_Params
{
	class UAnimMontage* InMontage; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.Multicast_OnShootHit
struct AAIMob_NTFox_Multicast_OnShootHit_Params
{
	struct FName BoneName; // (Parm, ZeroConstructor, IsPlainOldData)
	float DamageAmount; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.InternalTurn
struct AAIMob_NTFox_InternalTurn_Params
{
	struct FRotator TargetRotator; // (Parm, IsPlainOldData)
	float Duration; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.AIMob_NTFox.InternalPlayMontage
struct AAIMob_NTFox_InternalPlayMontage_Params
{
	class UAnimMontage* InMontage; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.AIMob_NTFox.GetTurnMontageAndCurve
struct AAIMob_NTFox_GetTurnMontageAndCurve_Params
{
	float InYawDelta; // (Parm, ZeroConstructor, IsPlainOldData)
	class UAnimMontage* OutMontage; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
	class UCurveVector* OutCurve; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};
...
// Function Addons.BioVehicleBase.IsLocalFollowingTarget
struct ABioVehicleBase_IsLocalFollowingTarget_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.PterosaurVehicle.BPMultiCastSwoopDown
struct APterosaurVehicle_BPMultiCastSwoopDown_Params
{
	struct FVector TargetLocation; // (Parm, IsPlainOldData)
};
...
// Function Addons.AnimInstance_FreeWallClimbing.OnWallClimbIdleChanged
struct UAnimInstance_FreeWallClimbing_OnWallClimbIdleChanged_Params
{
	bool bIsIdle; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AnimInstance_FreeWallClimbing.OnFreeWallRunStartOrEnd
struct UAnimInstance_FreeWallClimbing_OnFreeWallRunStartOrEnd_Params
{
	bool bStart; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AnimInstance_LocomotionSP.OnOwnerPreDoJump
struct UAnimInstance_LocomotionSP_OnOwnerPreDoJump_Params
{
};

// Function Addons.AnimInstance_LocomotionSP.OnGroundIdleChanged
struct UAnimInstance_LocomotionSP_OnGroundIdleChanged_Params
{
	bool bInIdle; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Addons.AttractMovementComponent.StopAttract
struct UAttractMovementComponent_StopAttract_Params
{
};

// Function Addons.AttractMovementComponent.StartAttractTo
struct UAttractMovementComponent_StartAttractTo_Params
{
	class AActor* InTargetActor; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.AttractMovementComponent.OnRep_TargetActor
struct UAttractMovementComponent_OnRep_TargetActor_Params
{
};

// Function Addons.AttractMovementComponent.IsAttracting
struct UAttractMovementComponent_IsAttracting_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.AttractMovementComponent.GetTargetActor
struct UAttractMovementComponent_GetTargetActor_Params
{
	class AActor* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.BioVehicleMovementComponent.OnLostOnServer
struct UBioVehicleMovementComponent_OnLostOnServer_Params
{
};
...
// Function Addons.CharacterAvoidObstacleComponent.ServerForceFinish
struct UCharacterAvoidObstacleComponent_ServerForceFinish_Params
{
};

// Function Addons.CharacterAvoidObstacleComponent.ServerAvoidObstacle
struct UCharacterAvoidObstacleComponent_ServerAvoidObstacle_Params
{
	struct FCustomVOHelper InVO; // (ConstParm, Parm, ReferenceParm)
};

// Function Addons.CharacterAvoidObstacleComponent.OnMovementModeChangedDelegate
struct UCharacterAvoidObstacleComponent_OnMovementModeChangedDelegate_Params
{
...
// Function Addons.CharacterAvoidObstacleComponent.NetMulticast_DoJumpObstacle
struct UCharacterAvoidObstacleComponent_NetMulticast_DoJumpObstacle_Params
{
	struct FVector InVelocity; // (ConstParm, Parm, ReferenceParm, IsPlainOldData)
};

// Function Addons.CharacterAvoidObstacleComponent.MulticastForceFinishVO
struct UCharacterAvoidObstacleComponent_MulticastForceFinishVO_Params
{
	float CD; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.CharacterAvoidObstacleComponent.FinishAvoidObstacle
struct UCharacterAvoidObstacleComponent_FinishAvoidObstacle_Params
{
	float CD; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Addons.BioVehicleAvoidObstacleComponent.OnMovementModeChangedDelegate2
struct UBioVehicleAvoidObstacleComponent_OnMovementModeChangedDelegate2_Params
{
	class ABioVehicleBase* Character; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EMovementMode> PrevMovementMode; // (Parm, ZeroConstructor, IsPlainOldData)
	unsigned char PreviousCustomMode; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.BuildingMeshArray.StartGradualShow
struct ABuildingMeshArray_StartGradualShow_Params
{
	int TargetCount; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.ShowMeshRange
struct ABuildingMeshArray_ShowMeshRange_Params
{
	int Count; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.ShowMesh
struct ABuildingMeshArray_ShowMesh_Params
{
	int MeshIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.ShowAllMeshes
struct ABuildingMeshArray_ShowAllMeshes_Params
{
};

// Function Addons.BuildingMeshArray.SetAnchorTarget
struct ABuildingMeshArray_SetAnchorTarget_Params
{
	class AActor* NewTarget; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.ResetAnchorFollowState
struct ABuildingMeshArray_ResetAnchorFollowState_Params
{
};

// Function Addons.BuildingMeshArray.OnRep_MeshVisibilityStates
struct ABuildingMeshArray_OnRep_MeshVisibilityStates_Params
{
};

// Function Addons.BuildingMeshArray.OnRep_MeshComponents
struct ABuildingMeshArray_OnRep_MeshComponents_Params
{
};

// DelegateFunction Addons.BuildingMeshArray.OnMeshVisibilityChanged__DelegateSignature
struct ABuildingMeshArray_OnMeshVisibilityChanged__DelegateSignature_Params
{
	int MeshIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bVisible; // (Parm, ZeroConstructor, IsPlainOldData)
};

// DelegateFunction Addons.BuildingMeshArray.OnMeshDestroyed__DelegateSignature
struct ABuildingMeshArray_OnMeshDestroyed__DelegateSignature_Params
{
	int MeshIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent* MeshComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};

// DelegateFunction Addons.BuildingMeshArray.OnMeshDamaged__DelegateSignature
struct ABuildingMeshArray_OnMeshDamaged__DelegateSignature_Params
{
	int MeshIndex; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.BuildingMeshArray.OnMeshComponentDied
struct ABuildingMeshArray_OnMeshComponentDied_Params
{
	class UStaticMeshComponent* MeshComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};

// DelegateFunction Addons.BuildingMeshArray.OnMeshAdded__DelegateSignature
struct ABuildingMeshArray_OnMeshAdded__DelegateSignature_Params
{
	int MeshIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent* MeshComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};

// DelegateFunction Addons.BuildingMeshArray.OnGradualShowCompleted__DelegateSignature
struct ABuildingMeshArray_OnGradualShowCompleted__DelegateSignature_Params
{
};

// DelegateFunction Addons.BuildingMeshArray.OnBatchShowCompleted__DelegateSignature
struct ABuildingMeshArray_OnBatchShowCompleted__DelegateSignature_Params
{
};

// DelegateFunction Addons.BuildingMeshArray.OnBatchCreateCompleted__DelegateSignature
struct ABuildingMeshArray_OnBatchCreateCompleted__DelegateSignature_Params
{
};

// DelegateFunction Addons.BuildingMeshArray.OnArrayInitialized__DelegateSignature
struct ABuildingMeshArray_OnArrayInitialized__DelegateSignature_Params
{
};

// Function Addons.BuildingMeshArray.IsMeshVisible
struct ABuildingMeshArray_IsMeshVisible_Params
{
	int MeshIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.IsBatchShowInProgress
struct ABuildingMeshArray_IsBatchShowInProgress_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.IsBatchCreateInProgress
struct ABuildingMeshArray_IsBatchCreateInProgress_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.InitializeMeshArray
struct ABuildingMeshArray_InitializeMeshArray_Params
{
};

// Function Addons.BuildingMeshArray.HideMesh
struct ABuildingMeshArray_HideMesh_Params
{
	int MeshIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.HideAllMeshes
struct ABuildingMeshArray_HideAllMeshes_Params
{
};

// Function Addons.BuildingMeshArray.GetTotalMeshCount
struct ABuildingMeshArray_GetTotalMeshCount_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.BuildingMeshArray.GetMeshComponent
struct ABuildingMeshArray_GetMeshComponent_Params
{
	int MeshIndex; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.BuildingMeshArray.AddCloneMeshes
struct ABuildingMeshArray_AddCloneMeshes_Params
{
	int Count; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bVisible; // (Parm, ZeroConstructor, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.MercenaryAnimInstanceBase.UnlinkPlayerSubInstance
struct UMercenaryAnimInstanceBase_UnlinkPlayerSubInstance_Params
{
	class UAnimInstance* InPlayerAnimInstance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryAnimInstanceBase.StopMontageBySlot
struct UMercenaryAnimInstanceBase_StopMontageBySlot_Params
{
	struct FName MontageSlot; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryAnimInstanceBase.SlotIsActive
struct UMercenaryAnimInstanceBase_SlotIsActive_Params
{
	struct FName SlotName; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.MercenaryAnimInstanceBase.OnEndInplaceTurn
struct UMercenaryAnimInstanceBase_OnEndInplaceTurn_Params
{
	bool bIsLeft; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryAnimInstanceBase.OnBeginInplaceTurn
struct UMercenaryAnimInstanceBase_OnBeginInplaceTurn_Params
{
	bool bIsLeft; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryAnimInstanceBase.LinkPlayerSubInstance
struct UMercenaryAnimInstanceBase_LinkPlayerSubInstance_Params
{
	class UAnimInstance* InPlayerAnimInstance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryAnimInstanceBase.HandlePlayerPickUp
struct UMercenaryAnimInstanceBase_HandlePlayerPickUp_Params
{
};

// Function Addons.MercenaryAnimInstanceBase.HandlePlayerEnterRescueState
struct UMercenaryAnimInstanceBase_HandlePlayerEnterRescueState_Params
{
	bool bBeginRescueing; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bSelfRescue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryAnimInstanceBase.HandlePlayerAnimMontagePlayDelegate
struct UMercenaryAnimInstanceBase_HandlePlayerAnimMontagePlayDelegate_Params
{
	class UAnimMontage* MontageToPlay; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bWantsPlay; // (Parm, ZeroConstructor, IsPlainOldData)
	float PlayRate; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.MercenaryAnimInstanceBase.HandlePlayerAnimMontageExtraPlayDelegate
struct UMercenaryAnimInstanceBase_HandlePlayerAnimMontageExtraPlayDelegate_Params
{
	class UAnimMontage* MontageToPlay; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bWantsPlay; // (Parm, ZeroConstructor, IsPlainOldData)
	float PlayRate; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.MercenaryAnimInstanceBase.HandleOnCarryBackPlayer
struct UMercenaryAnimInstanceBase_HandleOnCarryBackPlayer_Params
{
	bool bIsCarryBack; // (Parm, ZeroConstructor, IsPlainOldData)
	class ASTExtraBaseCharacter* InPlayer; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryPassengerAnimInstanceBase.OnPartnerMontageStop
struct UMercenaryPassengerAnimInstanceBase_OnPartnerMontageStop_Params
{
	class UAnimMontage* PlayedMontage; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bInterrupt; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryPassengerAnimInstanceBase.OnPartnerMontagePlay
struct UMercenaryPassengerAnimInstanceBase_OnPartnerMontagePlay_Params
{
	class UAnimMontage* PlayedMontage; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryPassengerAnimInstanceBase.OnDetachToPartner
struct UMercenaryPassengerAnimInstanceBase_OnDetachToPartner_Params
{
	class UAnimInstance* InPartnerAnimInstance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MercenaryPassengerAnimInstanceBase.OnAttachToPartner
struct UMercenaryPassengerAnimInstanceBase_OnAttachToPartner_Params
{
	class UAnimInstance* InPartnerAnimInstance; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Addons.CurveUtils.SetKeyValueByIndex
struct UCurveUtils_SetKeyValueByIndex_Params
{
...
// Function Addons.CurveUtils.SetKeyTimeAndValueByIndex
struct UCurveUtils_SetKeyTimeAndValueByIndex_Params
{
	class UCurveFloat* CurveFloat; // (Parm, ZeroConstructor, IsPlainOldData)
	int KeyIndex; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.CurveUtils.SetKeyInterpModeByIndex
struct UCurveUtils_SetKeyInterpModeByIndex_Params
{
	class UCurveFloat* CurveFloat; // (Parm, ZeroConstructor, IsPlainOldData)
	int KeyIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ERichCurveInterpMode> InterpMode; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.CurveUtils.RemoveKeyByIndex
struct UCurveUtils_RemoveKeyByIndex_Params
{
	class UCurveFloat* CurveFloat; // (Parm, ZeroConstructor, IsPlainOldData)
	int KeyIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.CurveUtils.RemoveKeyAtTime
struct UCurveUtils_RemoveKeyAtTime_Params
{
	class UCurveFloat* CurveFloat; // (Parm, ZeroConstructor, IsPlainOldData)
	float InTime; // (Parm, ZeroConstructor, IsPlainOldData)
	float TimeTolerance; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.CurveUtils.IsCurveValid
struct UCurveUtils_IsCurveValid_Params
{
	class UCurveFloat* CurveFloat; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.CurveUtils.GetNumKeys
struct UCurveUtils_GetNumKeys_Params
{
	class UCurveFloat* CurveFloat; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.CurveUtils.GetKeyTimeAndValue
struct UCurveUtils_GetKeyTimeAndValue_Params
{
	class UCurveFloat* CurveFloat; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	int KeyIndex; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.CurveUtils.GetCurveValueRange
struct UCurveUtils_GetCurveValueRange_Params
{
	class UCurveFloat* CurveFloat; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.CurveUtils.GetCurveTimeRange
struct UCurveUtils_GetCurveTimeRange_Params
{
	class UCurveFloat* CurveFloat; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.CurveUtils.EvaluateCurveFloat
struct UCurveUtils_EvaluateCurveFloat_Params
{
	class UCurveFloat* CurveFloat; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	float InTime; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.CurveUtils.CreateCurveFloatFromArrays
struct UCurveUtils_CreateCurveFloatFromArrays_Params
{
	TArray<float> Times; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
// Function Addons.CurveUtils.CreateCurveFloat
struct UCurveUtils_CreateCurveFloat_Params
{
	class UObject* Outer; // (Parm, ZeroConstructor, IsPlainOldData)
	class UCurveFloat* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.CurveUtils.ClearKeys
struct UCurveUtils_ClearKeys_Params
{
	class UCurveFloat* CurveFloat; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.CurveUtils.AddKeyWithTangents
struct UCurveUtils_AddKeyWithTangents_Params
{
	class UCurveFloat* CurveFloat; // (Parm, ZeroConstructor, IsPlainOldData)
	float InTime; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.CurveUtils.AddKey
struct UCurveUtils_AddKey_Params
{
	class UCurveFloat* CurveFloat; // (Parm, ZeroConstructor, IsPlainOldData)
	float InTime; // (Parm, ZeroConstructor, IsPlainOldData)
	float InValue; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.DroneVehicle.TickSyncCameraInfo
struct ADroneVehicle_TickSyncCameraInfo_Params
{
	float Delta; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.DroneVehicle.StopAllDroneSfx
struct ADroneVehicle_StopAllDroneSfx_Params
{
};

// Function Addons.DroneVehicle.SetMoveSpeedScale
struct ADroneVehicle_SetMoveSpeedScale_Params
{
	float InMoveSpeedScale; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.DroneVehicle.SetMaxTravelDistanceScale
struct ADroneVehicle_SetMaxTravelDistanceScale_Params
{
	float InMaxTravelDistanceScale; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.DroneVehicle.OnDistanceLimitReached
struct ADroneVehicle_OnDistanceLimitReached_Params
{
};

// Function Addons.DroneVehicle.CanUpdateMovementInput
struct ADroneVehicle_CanUpdateMovementInput_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.EPPointGroupActor.SaveToBlueprint
struct AEPPointGroupActor_SaveToBlueprint_Params
{
	class UBoxComponent* BoxComponent; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};

// Function Addons.EPPointGroupActor.GenerateSceneComponents
struct AEPPointGroupActor_GenerateSceneComponents_Params
{
	class UBoxComponent* BoxComponent; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
...
// Function Addons.FreeWallClimbingComponent.UpdateWallNormals
struct UFreeWallClimbingComponent_UpdateWallNormals_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.UpdateSurfaceState
struct UFreeWallClimbingComponent_UpdateSurfaceState_Params
{
};

// Function Addons.FreeWallClimbingComponent.UpdateCharacterRotation
struct UFreeWallClimbingComponent_UpdateCharacterRotation_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.ToggleWallRun
struct UFreeWallClimbingComponent_ToggleWallRun_Params
{
};

// Function Addons.FreeWallClimbingComponent.ToggleWallClimb
struct UFreeWallClimbingComponent_ToggleWallClimb_Params
{
};

// Function Addons.FreeWallClimbingComponent.TemporalFilterNormal
struct UFreeWallClimbingComponent_TemporalFilterNormal_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.SmoothWallNormals
struct UFreeWallClimbingComponent_SmoothWallNormals_Params
{
	struct FWallDetectionResult NewResult; // (Parm, OutParm)
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.ShouldEndClimbWall
struct UFreeWallClimbingComponent_ShouldEndClimbWall_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.SetIsWallRunning
struct UFreeWallClimbingComponent_SetIsWallRunning_Params
{
	bool bNewRunning; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.ServerToggleWallRun
struct UFreeWallClimbingComponent_ServerToggleWallRun_Params
{
	bool bEnabled; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.ServerRPC_StartWallClimb
struct UFreeWallClimbingComponent_ServerRPC_StartWallClimb_Params
{
};

// Function Addons.FreeWallClimbingComponent.ServerRPC_EndWallClimb
struct UFreeWallClimbingComponent_ServerRPC_EndWallClimb_Params
{
};

// Function Addons.FreeWallClimbingComponent.ServerRPC_CornerTransition
struct UFreeWallClimbingComponent_ServerRPC_CornerTransition_Params
{
	struct FCornerTransitionState TransitionData; // (ConstParm, Parm, ReferenceParm)
};

// Function Addons.FreeWallClimbingComponent.ServerCheckCornerTransition
struct UFreeWallClimbingComponent_ServerCheckCornerTransition_Params
{
	struct FCornerTransitionState TransitionData; // (ConstParm, Parm, OutParm, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.PreDoJump
struct UFreeWallClimbingComponent_PreDoJump_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnWeaponEquipped
struct UFreeWallClimbingComponent_OnWeaponEquipped_Params
{
...
// Function Addons.FreeWallClimbingComponent.OnSuitEquipped
struct UFreeWallClimbingComponent_OnSuitEquipped_Params
{
	bool bEnabled; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.OnStartWallClimb
struct UFreeWallClimbingComponent_OnStartWallClimb_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnStartCornerTransition
struct UFreeWallClimbingComponent_OnStartCornerTransition_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnRequestDropAgileItem
struct UFreeWallClimbingComponent_OnRequestDropAgileItem_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnRep_NetClimbState
struct UFreeWallClimbingComponent_OnRep_NetClimbState_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnRep_JumpTriggerCount
struct UFreeWallClimbingComponent_OnRep_JumpTriggerCount_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnRep_IsPlayingWallIdle
struct UFreeWallClimbingComponent_OnRep_IsPlayingWallIdle_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnRep_IsGroundIdle
struct UFreeWallClimbingComponent_OnRep_IsGroundIdle_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnRep_HasSpecificItem
struct UFreeWallClimbingComponent_OnRep_HasSpecificItem_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnEndWallClimb
struct UFreeWallClimbingComponent_OnEndWallClimb_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnEndCornerTransition
struct UFreeWallClimbingComponent_OnEndCornerTransition_Params
{
};

// Function Addons.FreeWallClimbingComponent.OnAgileLocomotionEnabled
struct UFreeWallClimbingComponent_OnAgileLocomotionEnabled_Params
{
	bool bEnabled; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.MulticastRPC_CornerTransition
struct UFreeWallClimbingComponent_MulticastRPC_CornerTransition_Params
{
	struct FCornerTransitionState TransitionData; // (ConstParm, Parm, ReferenceParm)
};

// Function Addons.FreeWallClimbingComponent.MulticastRPC_CancelCornerTransition
struct UFreeWallClimbingComponent_MulticastRPC_CancelCornerTransition_Params
{
};

// Function Addons.FreeWallClimbingComponent.LuaOnStartWallClimb
struct UFreeWallClimbingComponent_LuaOnStartWallClimb_Params
{
};

// Function Addons.FreeWallClimbingComponent.LuaOnStartCornerTransition
struct UFreeWallClimbingComponent_LuaOnStartCornerTransition_Params
{
};

// Function Addons.FreeWallClimbingComponent.LuaOnRepNetClimbState
struct UFreeWallClimbingComponent_LuaOnRepNetClimbState_Params
{
};

// Function Addons.FreeWallClimbingComponent.LuaOnEndWallClimb
struct UFreeWallClimbingComponent_LuaOnEndWallClimb_Params
{
};

// Function Addons.FreeWallClimbingComponent.LuaOnEndCornerTransition
struct UFreeWallClimbingComponent_LuaOnEndCornerTransition_Params
{
};

// Function Addons.FreeWallClimbingComponent.LuaCanClimbWall
struct UFreeWallClimbingComponent_LuaCanClimbWall_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.IsWallTallEnough
struct UFreeWallClimbingComponent_IsWallTallEnough_Params
{
	struct FWallDetectionResult WallHit; // (ConstParm, Parm, OutParm, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.IsValidWallNormal
struct UFreeWallClimbingComponent_IsValidWallNormal_Params
{
	struct FVector Normal; // (Parm, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.IsSuitEquipped
struct UFreeWallClimbingComponent_IsSuitEquipped_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.IsInCooldown
struct UFreeWallClimbingComponent_IsInCooldown_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.IsAgileAnimEnabled
struct UFreeWallClimbingComponent_IsAgileAnimEnabled_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.HasValidWall
struct UFreeWallClimbingComponent_HasValidWall_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.GetIsWallRunning
struct UFreeWallClimbingComponent_GetIsWallRunning_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.DrawDebugDetectionInfo
struct UFreeWallClimbingComponent_DrawDebugDetectionInfo_Params
{
};

// Function Addons.FreeWallClimbingComponent.DetectWallSurfaces
struct UFreeWallClimbingComponent_DetectWallSurfaces_Params
{
	struct FWallDetectionResult ReturnValue; // (Parm, OutParm, ReturnParm)
};

// Function Addons.FreeWallClimbingComponent.CanWallClimbFromHit
struct UFreeWallClimbingComponent_CanWallClimbFromHit_Params
{
	struct FHitResult Hit; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.CanWallClimbActor
struct UFreeWallClimbingComponent_CanWallClimbActor_Params
{
	class AActor* InActor; // (Parm, ZeroConstructor, IsPlainOldData)
	class UActorComponent* InComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.FreeWallClimbingComponent.CanClimbWall
struct UFreeWallClimbingComponent_CanClimbWall_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.LuaCustomMoveObj.RegisterParamSet
struct ULuaCustomMoveObj_RegisterParamSet_Params
{
	struct FLuaCustomParamSet InParamSet; // (ConstParm, Parm, OutParm, ReferenceParm)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.OnParamSetChanged
struct ULuaCustomMoveObj_OnParamSetChanged_Params
{
	int OldIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	int NewIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.OnLuaCustomLeave
struct ULuaCustomMoveObj_OnLuaCustomLeave_Params
{
};

// Function Addons.LuaCustomMoveObj.OnLuaCustomEnter
struct ULuaCustomMoveObj_OnLuaCustomEnter_Params
{
	struct FName ParamSetKey; // (Parm, ZeroConstructor, IsPlainOldData)
	int ParamSetIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.OnExitFlyingMode
struct ULuaCustomMoveObj_OnExitFlyingMode_Params
{
};

// Function Addons.LuaCustomMoveObj.OnEnterFlyingMode
struct ULuaCustomMoveObj_OnEnterFlyingMode_Params
{
};

// Function Addons.LuaCustomMoveObj.LeaveLuaCustom
struct ULuaCustomMoveObj_LeaveLuaCustom_Params
{
};

// Function Addons.LuaCustomMoveObj.IsFlyingMode
struct ULuaCustomMoveObj_IsFlyingMode_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.HandleCharacterParamSetIndexChanged
struct ULuaCustomMoveObj_HandleCharacterParamSetIndexChanged_Params
{
	unsigned char OldIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	unsigned char NewIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.GetParamSetCount
struct ULuaCustomMoveObj_GetParamSetCount_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.GetActiveParamSetKey
struct ULuaCustomMoveObj_GetActiveParamSetKey_Params
{
	struct FName ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.GetActiveParamSetIndex
struct ULuaCustomMoveObj_GetActiveParamSetIndex_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.GetActiveParamSet
struct ULuaCustomMoveObj_GetActiveParamSet_Params
{
	struct FLuaCustomParamSet ReturnValue; // (Parm, OutParm, ReturnParm)
};

// Function Addons.LuaCustomMoveObj.FindParamSetIndex
struct ULuaCustomMoveObj_FindParamSetIndex_Params
{
	struct FName Key; // (Parm, ZeroConstructor, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.ExitFlyingMode
struct ULuaCustomMoveObj_ExitFlyingMode_Params
{
};

// Function Addons.LuaCustomMoveObj.EnterLuaCustomByKey
struct ULuaCustomMoveObj_EnterLuaCustomByKey_Params
{
	struct FName ParamSetKey; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.EnterLuaCustomByIndex
struct ULuaCustomMoveObj_EnterLuaCustomByIndex_Params
{
	int ParamSetIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.EnterFlyingMode
struct ULuaCustomMoveObj_EnterFlyingMode_Params
{
};

// Function Addons.LuaCustomMoveObj.ClearAllParamSets
struct ULuaCustomMoveObj_ClearAllParamSets_Params
{
};

// Function Addons.LuaCustomMoveObj.ActivateParamSetByKey
struct ULuaCustomMoveObj_ActivateParamSetByKey_Params
{
	struct FName Key; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.LuaCustomMoveObj.ActivateParamSetByIndex
struct ULuaCustomMoveObj_ActivateParamSetByIndex_Params
{
	int Index; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Addons.TyrannosaurusRexVehicle.OnTakeRoarAttackDamage
struct ATyrannosaurusRexVehicle_OnTakeRoarAttackDamage_Params
{
...
// Function Addons.MonsterActorBase.IsInObjectPool
struct AMonsterActorBase_IsInObjectPool_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.MyriapodVehicleAIController.SetMoveTargetLoc
struct AMyriapodVehicleAIController_SetMoveTargetLoc_Params
{
	struct FVector TargetLoc; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Addons.MyriapodVehicleAIController.SetCaughtOwner
struct AMyriapodVehicleAIController_SetCaughtOwner_Params
{
	class AActor* CaughtOwner; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MyriapodVehicleAIController.RunBehaviorTreeWithIndex
struct AMyriapodVehicleAIController_RunBehaviorTreeWithIndex_Params
{
	int TreeIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.MyriapodVehicleAIController.OnAirDropLandGroup
struct AMyriapodVehicleAIController_OnAirDropLandGroup_Params
{
	class AActor* AirDropBoxActor; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bIsInWater; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Addons.NinjaMoveAnimInstance.ShouldPlayJumpParticle
struct UNinjaMoveAnimInstance_ShouldPlayJumpParticle_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveAnimInstance.OnPlayerEnterJump
struct UNinjaMoveAnimInstance_OnPlayerEnterJump_Params
{
};

// Function Addons.NinjaMoveAnimInstance.OnJumpEnterNTMove
struct UNinjaMoveAnimInstance_OnJumpEnterNTMove_Params
{
};

// Function Addons.NinjaMoveAnimInstance.HandlePlayerPickUp
struct UNinjaMoveAnimInstance_HandlePlayerPickUp_Params
{
};

// Function Addons.NinjaMoveComponent.TryLeaveNinjaTeam
struct UNinjaMoveComponent_TryLeaveNinjaTeam_Params
{
	class ASTExtraBaseCharacter* FollowerPlayer; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.TryLeaveCurrentNinjaTeam
struct UNinjaMoveComponent_TryLeaveCurrentNinjaTeam_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.TryJoinNinjaTeamWithPendingLeader
struct UNinjaMoveComponent_TryJoinNinjaTeamWithPendingLeader_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.TryJoinNinjaTeam
struct UNinjaMoveComponent_TryJoinNinjaTeam_Params
{
	class ASTExtraBaseCharacter* FollowerPlayer; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.StopSprintAudio
struct UNinjaMoveComponent_StopSprintAudio_Params
{
};

// Function Addons.NinjaMoveComponent.SetTeamShape
struct UNinjaMoveComponent_SetTeamShape_Params
{
	ENinjaTeamShape InTeamShapeType; // (Parm, ZeroConstructor, IsPlainOldData)
	float InRowSpacing; // (Parm, ZeroConstructor, IsPlainOldData)
	float InColumnSpacing; // (Parm, ZeroConstructor, IsPlainOldData)
	int InRowCapacity_Triangle; // (Parm, ZeroConstructor, IsPlainOldData)
	int InRowCapacity_LineX; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.SetMoveIgnoreBetween
struct UNinjaMoveComponent_SetMoveIgnoreBetween_Params
{
	class ASTExtraBaseCharacter* A; // (Parm, ZeroConstructor, IsPlainOldData)
	class ASTExtraBaseCharacter* B; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bIgnore; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.ServerGetFollowerDesiredPosition
struct UNinjaMoveComponent_ServerGetFollowerDesiredPosition_Params
{
	class ASTExtraBaseCharacter* InFollowerPlayer; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector OutPosition; // (Parm, OutParm, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.ServerDoNinjaJump
struct UNinjaMoveComponent_ServerDoNinjaJump_Params
{
};

// Function Addons.NinjaMoveComponent.RefreshTeamCollisionMembers
struct UNinjaMoveComponent_RefreshTeamCollisionMembers_Params
{
};

// Function Addons.NinjaMoveComponent.PlaySprintAudio
struct UNinjaMoveComponent_PlaySprintAudio_Params
{
};

// Function Addons.NinjaMoveComponent.OnSpecialMoveTypeChanged
struct UNinjaMoveComponent_OnSpecialMoveTypeChanged_Params
{
	ESpecialMovementType SpecialMovementType; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.OnRep_TeamCollisionMembers
struct UNinjaMoveComponent_OnRep_TeamCollisionMembers_Params
{
};

// Function Addons.NinjaMoveComponent.OnRep_NinjaMoveState
struct UNinjaMoveComponent_OnRep_NinjaMoveState_Params
{
};

// Function Addons.NinjaMoveComponent.OnPawnStateInterrupted
struct UNinjaMoveComponent_OnPawnStateInterrupted_Params
{
	EPawnState State; // (Parm, ZeroConstructor, IsPlainOldData)
	EPawnState InterruptedBy; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.OnPawnLeaveState
struct UNinjaMoveComponent_OnPawnLeaveState_Params
{
	EPawnState State; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.OnPawnEnterState
struct UNinjaMoveComponent_OnPawnEnterState_Params
{
	EPawnState State; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.OnFollowersCountChanged
struct UNinjaMoveComponent_OnFollowersCountChanged_Params
{
};

// Function Addons.NinjaMoveComponent.OnClientNinjaStatChanged
struct UNinjaMoveComponent_OnClientNinjaStatChanged_Params
{
	struct FNinjaMoveState NewState; // (Parm)
};

// Function Addons.NinjaMoveComponent.MulticastDoNinjaJump
struct UNinjaMoveComponent_MulticastDoNinjaJump_Params
{
};

// Function Addons.NinjaMoveComponent.IsNinjaMoving
struct UNinjaMoveComponent_IsNinjaMoving_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.IsMoveOnWater
struct UNinjaMoveComponent_IsMoveOnWater_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.IsLeader
struct UNinjaMoveComponent_IsLeader_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.GetNinjaMoveAcceleration
struct UNinjaMoveComponent_GetNinjaMoveAcceleration_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.GetLeaderNinjaMoveComponent
struct UNinjaMoveComponent_GetLeaderNinjaMoveComponent_Params
{
	class UNinjaMoveComponent* ReturnValue; // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.GetLeader
struct UNinjaMoveComponent_GetLeader_Params
{
	class ASTExtraBaseCharacter* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.GenerateTeamShapePositions
struct UNinjaMoveComponent_GenerateTeamShapePositions_Params
{
	int InFollowerNum; // (Parm, ZeroConstructor, IsPlainOldData)
	ENinjaTeamShape InTeamShape; // (Parm, ZeroConstructor, IsPlainOldData)
	TArray<struct FTeamPosition> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function Addons.NinjaMoveComponent.ExitNinjaMove
struct UNinjaMoveComponent_ExitNinjaMove_Params
{
};

// Function Addons.NinjaMoveComponent.EnterNinjaMove
struct UNinjaMoveComponent_EnterNinjaMove_Params
{
	class ASTExtraBaseCharacter* InLeaderPlayer; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.DoNinjaJump
struct UNinjaMoveComponent_DoNinjaJump_Params
{
};

// Function Addons.NinjaMoveComponent.ClearAudioAndParticle
struct UNinjaMoveComponent_ClearAudioAndParticle_Params
{
};

// Function Addons.NinjaMoveComponent.CanJointNinjaTeam
struct UNinjaMoveComponent_CanJointNinjaTeam_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaMoveComponent.ApplyTeamCollisionIgnore
struct UNinjaMoveComponent_ApplyTeamCollisionIgnore_Params
{
};

// Function Addons.NinjaMoveObj.OnEndWalkOnWater
struct UNinjaMoveObj_OnEndWalkOnWater_Params
{
};

// Function Addons.NinjaMoveObj.OnBeginWalkOnWater
struct UNinjaMoveObj_OnBeginWalkOnWater_Params
{
};

// Function Addons.NinjaMoveObj.IsPlayerInRoom
struct UNinjaMoveObj_IsPlayerInRoom_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaRushComponent.StopRush
struct UNinjaRushComponent_StopRush_Params
{
};

// Function Addons.NinjaRushComponent.StartRush
struct UNinjaRushComponent_StartRush_Params
{
};

// Function Addons.NinjaRushComponent.OnRep_NinjaMoveState
struct UNinjaRushComponent_OnRep_NinjaMoveState_Params
{
	struct FNinjaRushState OldState; // (Parm)
};

// Function Addons.NinjaRushComponent.IsRushActive
struct UNinjaRushComponent_IsRushActive_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NinjaRushObj.StopRush
struct UNinjaRushObj_StopRush_Params
{
};

// Function Addons.NinjaRushObj.StartRush
struct UNinjaRushObj_StartRush_Params
{
};

// Function Addons.NinjaRushObj.OnEndWalkOnWater
struct UNinjaRushObj_OnEndWalkOnWater_Params
{
};

// Function Addons.NinjaRushObj.OnBeginWalkOnWater
struct UNinjaRushObj_OnBeginWalkOnWater_Params
{
};

// Function Addons.NinjaRushObj.IsRushActive
struct UNinjaRushObj_IsRushActive_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.NTFoxAnimInstance.RequestTurn
struct UNTFoxAnimInstance_RequestTurn_Params
{
	struct FRotator TargetRotator; // (Parm, IsPlainOldData)
	float Duration; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NTFoxAnimInstance.PreRequestTurn
struct UNTFoxAnimInstance_PreRequestTurn_Params
{
	struct FRotator TargetRotator; // (Parm, IsPlainOldData)
	float Duration; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NTFoxAnimInstance.PlayHitMontage
struct UNTFoxAnimInstance_PlayHitMontage_Params
{
};

// Function Addons.NTFoxAnimInstance.OnStop
struct UNTFoxAnimInstance_OnStop_Params
{
};

// Function Addons.NTFoxAnimInstance.OnNTFoxStanceChanged
struct UNTFoxAnimInstance_OnNTFoxStanceChanged_Params
{
	EFoxStance OldStance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NTFoxAnimInstance.OnNTFoxGaitChanged
struct UNTFoxAnimInstance_OnNTFoxGaitChanged_Params
{
	ENTFoxGait OldGait; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NTFoxAnimInstance.OnFoxHit
struct UNTFoxAnimInstance_OnFoxHit_Params
{
	struct FName HitBoneName; // (Parm, ZeroConstructor, IsPlainOldData)
	float HitAmount; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NTFoxAnimInstance.OnCircleStop
struct UNTFoxAnimInstance_OnCircleStop_Params
{
};

// Function Addons.NTFoxAnimInstance.GetCircleStopSequence
struct UNTFoxAnimInstance_GetCircleStopSequence_Params
{
	struct FMotionSearchResult OutResult; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NTFoxAnimInstance.GetBestStopSequence
struct UNTFoxAnimInstance_GetBestStopSequence_Params
{
	struct FMotionSearchResult OutResult; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NTFoxMovementComponent.SetPreciseMovementTarget
struct UNTFoxMovementComponent_SetPreciseMovementTarget_Params
{
	struct FVector TargetLocation; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Addons.NTFoxMovementComponent.SetPreciseFixedScale
struct UNTFoxMovementComponent_SetPreciseFixedScale_Params
{
	float inScale; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NTFoxMovementComponent.ScanAndIgnoreObstaclesAhead
struct UNTFoxMovementComponent_ScanAndIgnoreObstaclesAhead_Params
{
	float ForwardDistance; // (Parm, ZeroConstructor, IsPlainOldData)
	ENTFoxScanDir ScanDir; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bSimpleFoliageOnly; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.NTFoxMovementComponent.Multicast_ScanAndIgnoreObstaclesAhead_RPC
struct UNTFoxMovementComponent_Multicast_ScanAndIgnoreObstaclesAhead_RPC_Params
{
	float ForwardDistance; // (Parm, ZeroConstructor, IsPlainOldData)
	ENTFoxScanDir ScanDir; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bSimpleFoliageOnly; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.NTFoxMovementComponent.Multicast_ScanAndIgnoreObstaclesAhead
struct UNTFoxMovementComponent_Multicast_ScanAndIgnoreObstaclesAhead_Params
{
	float ForwardDistance; // (Parm, ZeroConstructor, IsPlainOldData)
	ENTFoxScanDir ScanDir; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bSimpleFoliageOnly; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.NTFoxMovementComponent.Multicast_ClearMoveIgnoreObstacles_RPC
struct UNTFoxMovementComponent_Multicast_ClearMoveIgnoreObstacles_RPC_Params
{
};

// Function Addons.NTFoxMovementComponent.Multicast_ClearMoveIgnoreObstacles
struct UNTFoxMovementComponent_Multicast_ClearMoveIgnoreObstacles_Params
{
};

// Function Addons.NTFoxMovementComponent.HasBlockingObstacleAhead
struct UNTFoxMovementComponent_HasBlockingObstacleAhead_Params
{
	float Distance; // (Parm, ZeroConstructor, IsPlainOldData)
	ENTFoxScanDir ScanDir; // (Parm, ZeroConstructor, IsPlainOldData)
	float HeightOffset; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bIgnoreFoliageActors; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.NTFoxMovementComponent.ClearPrecisePrediction
struct UNTFoxMovementComponent_ClearPrecisePrediction_Params
{
};

// Function Addons.NTFoxMovementComponent.ClearPreciseMovementTarget
struct UNTFoxMovementComponent_ClearPreciseMovementTarget_Params
{
};

// Function Addons.NTFoxMovementComponent.ClearMoveIgnoreObstacles
struct UNTFoxMovementComponent_ClearMoveIgnoreObstacles_Params
{
};
...
// Function Addons.PickTargetConfigObject.PrepareTraceData
struct UPickTargetConfigObject_PrepareTraceData_Params
{
	struct FPickTargetContext Context; // (Parm, OutParm, ReferenceParm)
	struct FPickTargetConfig Config; // (ConstParm, Parm, OutParm, ReferenceParm)
};

// Function Addons.PickTargetSubsystem.TryInitializeByLua
struct UPickTargetSubsystem_TryInitializeByLua_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.PickTargetSubsystem.RegisterPickConfigByObject
struct UPickTargetSubsystem_RegisterPickConfigByObject_Params
{
	class UPickTargetConfigObject* ConfigObject; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.PickTargetSubsystem.PickTargetByKey
struct UPickTargetSubsystem_PickTargetByKey_Params
{
	class ACharacter* OwnerChar; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.PickTargetSubsystem.GetPickConfig
struct UPickTargetSubsystem_GetPickConfig_Params
{
	struct FName Key; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
	struct FPickTargetConfig OutConfig; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.SpecialMoveObj_FreeWallClimbing.TickCornerTransition
struct USpecialMoveObj_FreeWallClimbing_TickCornerTransition_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.StepUpObstacle
struct USpecialMoveObj_FreeWallClimbing_StepUpObstacle_Params
{
	struct FVector MovementDelta; // (Parm, IsPlainOldData)
	struct FHitResult Hit; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.StartWallClimb
struct USpecialMoveObj_FreeWallClimbing_StartWallClimb_Params
{
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.StartCornerTransition
struct USpecialMoveObj_FreeWallClimbing_StartCornerTransition_Params
{
	struct FCornerTransitionState TransitionData; // (ConstParm, Parm, OutParm, ReferenceParm)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.SafeMoveClimbCapsule
struct USpecialMoveObj_FreeWallClimbing_SafeMoveClimbCapsule_Params
{
	struct FVector MoveDelta; // (Parm, IsPlainOldData)
	struct FQuat NewQuat; // (Parm, IsPlainOldData)
	struct FHitResult OutFinalHit; // (Parm, OutParm, IsPlainOldData)
	struct FHitResult OutRootHit; // (Parm, OutParm, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.ProjectVectorOnToWall
struct USpecialMoveObj_FreeWallClimbing_ProjectVectorOnToWall_Params
{
	struct FVector WorldVector; // (Parm, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.PhysWallClimb
struct USpecialMoveObj_FreeWallClimbing_PhysWallClimb_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
	int Iterations; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.OnStartWallClimb
struct USpecialMoveObj_FreeWallClimbing_OnStartWallClimb_Params
{
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.OnEndWallClimb
struct USpecialMoveObj_FreeWallClimbing_OnEndWallClimb_Params
{
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.MoveClimbCapsule
struct USpecialMoveObj_FreeWallClimbing_MoveClimbCapsule_Params
{
	struct FVector MoveDelta; // (Parm, IsPlainOldData)
	struct FQuat NewQuat; // (Parm, IsPlainOldData)
...
// Function Addons.SpecialMoveObj_FreeWallClimbing.MoveAlongWallSurface
struct USpecialMoveObj_FreeWallClimbing_MoveAlongWallSurface_Params
{
	struct FVector MovementDelta; // (Parm, IsPlainOldData)
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.IsWallClimbing
struct USpecialMoveObj_FreeWallClimbing_IsWallClimbing_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.IsTransitioningCorner
struct USpecialMoveObj_FreeWallClimbing_IsTransitioningCorner_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.GetWallTangentVector
struct USpecialMoveObj_FreeWallClimbing_GetWallTangentVector_Params
{
	struct FVector WorldDirection; // (Parm, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.GetWallClimbInputVector
struct USpecialMoveObj_FreeWallClimbing_GetWallClimbInputVector_Params
{
	struct FVector RawInput; // (Parm, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.GetAngleBetweenWalls
struct USpecialMoveObj_FreeWallClimbing_GetAngleBetweenWalls_Params
{
	struct FVector NormalA; // (Parm, IsPlainOldData)
	struct FVector NormalB; // (Parm, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.EndWallClimb
struct USpecialMoveObj_FreeWallClimbing_EndWallClimb_Params
{
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.EndCornerTransition
struct USpecialMoveObj_FreeWallClimbing_EndCornerTransition_Params
{
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.DrawDebugMovementInfo
struct USpecialMoveObj_FreeWallClimbing_DrawDebugMovementInfo_Params
{
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.DetectWallToRoof
struct USpecialMoveObj_FreeWallClimbing_DetectWallToRoof_Params
{
	struct FVector movedir; // (Parm, IsPlainOldData)
	struct FWallDetectionResult OutHit; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.DetectWallToFloor
struct USpecialMoveObj_FreeWallClimbing_DetectWallToFloor_Params
{
	struct FVector movedir; // (Parm, IsPlainOldData)
	struct FWallDetectionResult OutHit; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.SpecialMoveObj_FreeWallClimbing.DetectWallInDirection
struct USpecialMoveObj_FreeWallClimbing_DetectWallInDirection_Params
{
	struct FVector Loc; // (Parm, IsPlainOldData)
	struct FVector DetectDir; // (Parm, IsPlainOldData)
	struct FWallDetectionResult OutHit; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.DetectWallCeilingCorner
struct USpecialMoveObj_FreeWallClimbing_DetectWallCeilingCorner_Params
{
	struct FVector movedir; // (Parm, IsPlainOldData)
	struct FWallDetectionResult OutHit; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.SpecialMoveObj_FreeWallClimbing.DetectConvexCorner
struct USpecialMoveObj_FreeWallClimbing_DetectConvexCorner_Params
{
	struct FVector movedir; // (Parm, IsPlainOldData)
	struct FWallDetectionResult OutHit; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.SpecialMoveObj_FreeWallClimbing.DetectConcaveCorner
struct USpecialMoveObj_FreeWallClimbing_DetectConcaveCorner_Params
{
	struct FVector movedir; // (Parm, IsPlainOldData)
	struct FWallDetectionResult OutHit; // (Parm, OutParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.SpecialMoveObj_FreeWallClimbing.ConstructCornerTransition
struct USpecialMoveObj_FreeWallClimbing_ConstructCornerTransition_Params
{
	struct FWallDetectionResult InCornerHit; // (Parm, OutParm)
	struct FCornerTransitionState OutTransitionData; // (Parm, OutParm)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.CancelCornerTransition
struct USpecialMoveObj_FreeWallClimbing_CancelCornerTransition_Params
{
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.CalculateWallClimbVelocity
struct USpecialMoveObj_FreeWallClimbing_CalculateWallClimbVelocity_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.CacheFreeWallClimbingComp
struct USpecialMoveObj_FreeWallClimbing_CacheFreeWallClimbingComp_Params
{
};

// Function Addons.SpecialMoveObj_FreeWallClimbing.AdjustToWallSurface
struct USpecialMoveObj_FreeWallClimbing_AdjustToWallSurface_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Addons.SpecialMoveObj_Quadruped.SpecialMoveSetCharacterOwner
struct USpecialMoveObj_Quadruped_SpecialMoveSetCharacterOwner_Params
{
	class ASTExtraBaseCharacter* InOwner; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_Quadruped.GetSpeedRate
struct USpecialMoveObj_Quadruped_GetSpeedRate_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpecialMoveObj_Quadruped.GetMaxRunSpeed
struct USpecialMoveObj_Quadruped_GetMaxRunSpeed_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.StartSwing
struct USpiderSwingMoveObj_StartSwing_Params
{
	struct FVector InAttachPoint; // (Parm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.SetSwingInput
struct USpiderSwingMoveObj_SetSwingInput_Params
{
	float ForwardInput; // (Parm, ZeroConstructor, IsPlainOldData)
	float RightInput; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.SetMoveState
struct USpiderSwingMoveObj_SetMoveState_Params
{
	ESpiderSwingMoveState NewMoveState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.SetFallingFloatExceedThreshold
struct USpiderSwingMoveObj_SetFallingFloatExceedThreshold_Params
{
	int InValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.SetFallingCheckWindow
struct USpiderSwingMoveObj_SetFallingCheckWindow_Params
{
	float InValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.SetFallingCheckMinDescendDist
struct USpiderSwingMoveObj_SetFallingCheckMinDescendDist_Params
{
	float InValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.RequestStartSwing
struct USpiderSwingMoveObj_RequestStartSwing_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.RequestReleaseSwing
struct USpiderSwingMoveObj_RequestReleaseSwing_Params
{
};

// Function Addons.SpiderSwingMoveObj.ReleaseSwing
struct USpiderSwingMoveObj_ReleaseSwing_Params
{
};

// Function Addons.SpiderSwingMoveObj.OnServerAppDeactivated
struct USpiderSwingMoveObj_OnServerAppDeactivated_Params
{
	bool bAppActive; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.OnPawnStateInterrupted
struct USpiderSwingMoveObj_OnPawnStateInterrupted_Params
{
	EPawnState State; // (Parm, ZeroConstructor, IsPlainOldData)
	EPawnState InterruptedBy; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.OnPawnLeaveWebSwing
struct USpiderSwingMoveObj_OnPawnLeaveWebSwing_Params
{
	bool bIsInterrupted; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.OnPawnLeaveState
struct USpiderSwingMoveObj_OnPawnLeaveState_Params
{
	EPawnState LeaveState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.OnCurrentUsingWeaponChanged
struct USpiderSwingMoveObj_OnCurrentUsingWeaponChanged_Params
{
	TEnumAsByte<enum ESurviveWeaponPropSlot> TargetChangeSlot; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.LeaveSpiderSwingMove
struct USpiderSwingMoveObj_LeaveSpiderSwingMove_Params
{
};

// Function Addons.SpiderSwingMoveObj.IsUsingRightHand
struct USpiderSwingMoveObj_IsUsingRightHand_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.IsOnGround
struct USpiderSwingMoveObj_IsOnGround_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.GetSyncComponent
struct USpiderSwingMoveObj_GetSyncComponent_Params
{
	class USpiderSwingSyncComponent* ReturnValue; // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.GetSwingAngle
struct USpiderSwingMoveObj_GetSwingAngle_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.GetRopeLength
struct USpiderSwingMoveObj_GetRopeLength_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.GetRopeDirection
struct USpiderSwingMoveObj_GetRopeDirection_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.GetDistanceToLand
struct USpiderSwingMoveObj_GetDistanceToLand_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.GetCurrentHandSide
struct USpiderSwingMoveObj_GetCurrentHandSide_Params
{
	ESpiderSwingHandSide ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.GetCurMoveState
struct USpiderSwingMoveObj_GetCurMoveState_Params
{
	ESpiderSwingMoveState ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.GetAttachPoint
struct USpiderSwingMoveObj_GetAttachPoint_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingMoveObj.ForceExitSwingWithCorrection
struct USpiderSwingMoveObj_ForceExitSwingWithCorrection_Params
{
};

// Function Addons.SpiderSwingMoveObj.FindSwingAttachPoint
struct USpiderSwingMoveObj_FindSwingAttachPoint_Params
{
	struct FSpiderSwingDetectResult ReturnValue; // (Parm, OutParm, ReturnParm)
};

// Function Addons.SpiderSwingMoveObj.EnterSpiderSwingMove
struct USpiderSwingMoveObj_EnterSpiderSwingMove_Params
{
};

// Function Addons.SpiderSwingMoveObj.DetachRopeAsLingering
struct USpiderSwingMoveObj_DetachRopeAsLingering_Params
{
};

// Function Addons.SpiderSwingMoveObj.DestroySyncComponent
struct USpiderSwingMoveObj_DestroySyncComponent_Params
{
};

// Function Addons.SpiderSwingMoveObj.DestroyRopeEndEffect
struct USpiderSwingMoveObj_DestroyRopeEndEffect_Params
{
};

// Function Addons.SpiderSwingMoveObj.CreateSyncComponent
struct USpiderSwingMoveObj_CreateSyncComponent_Params
{
};

// Function Addons.SpiderSwingMoveObj.CreateRopeEndEffect
struct USpiderSwingMoveObj_CreateRopeEndEffect_Params
{
};

// Function Addons.SpiderSwingSyncComponent.ServerSetSwingInput
struct USpiderSwingSyncComponent_ServerSetSwingInput_Params
{
	float ForwardInput; // (Parm, ZeroConstructor, IsPlainOldData)
	float RightInput; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingSyncComponent.ServerSetMoveState
struct USpiderSwingSyncComponent_ServerSetMoveState_Params
{
	ESpiderSwingMoveState NewState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingSyncComponent.ServerRequestStartSwing
struct USpiderSwingSyncComponent_ServerRequestStartSwing_Params
{
	struct FSpiderSwingStartRequest InRequest; // (ConstParm, Parm, ReferenceParm)
};

// Function Addons.SpiderSwingSyncComponent.ServerReleaseSwing
struct USpiderSwingSyncComponent_ServerReleaseSwing_Params
{
};

// Function Addons.SpiderSwingSyncComponent.ServerNotifyLanded
struct USpiderSwingSyncComponent_ServerNotifyLanded_Params
{
	struct FVector LandLocation; // (Parm, IsPlainOldData)
};

// Function Addons.SpiderSwingSyncComponent.OnRep_SyncData
struct USpiderSwingSyncComponent_OnRep_SyncData_Params
{
};

// Function Addons.SpiderSwingSyncComponent.MulticastSwingStateChanged
struct USpiderSwingSyncComponent_MulticastSwingStateChanged_Params
{
	struct FSpiderSwingSyncData SyncData; // (Parm)
};

// Function Addons.SpiderSwingSyncComponent.InitWithMoveObj
struct USpiderSwingSyncComponent_InitWithMoveObj_Params
{
	class USpiderSwingMoveObj* InMoveObj; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.SpiderSwingSyncComponent.GetSyncData
struct USpiderSwingSyncComponent_GetSyncData_Params
{
	struct FSpiderSwingSyncData ReturnValue; // (ConstParm, Parm, OutParm, ReturnParm, ReferenceParm)
};

// Function Addons.SpiderSwingSyncComponent.GetMoveObj
struct USpiderSwingSyncComponent_GetMoveObj_Params
{
	class USpiderSwingMoveObj* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.SpiderSwingSyncComponent.GatherSyncData
struct USpiderSwingSyncComponent_GatherSyncData_Params
{
};

// Function Addons.SpiderSwingSyncComponent.ClientAdjustSwingState
struct USpiderSwingSyncComponent_ClientAdjustSwingState_Params
{
	struct FSpiderSwingSyncData SyncData; // (Parm)
};
...
// Function Addons.STBuffAction_AddOneSkill.OnExecute
struct USTBuffAction_AddOneSkill_OnExecute_Params
{
};

// Function Addons.STBuffAction_AddOneSkill.OnEnd
struct USTBuffAction_AddOneSkill_OnEnd_Params
{
};
...
// Function Addons.STBuffAction_AddSkillToken.OnExecute
struct USTBuffAction_AddSkillToken_OnExecute_Params
{
};

// Function Addons.STBuffAction_AddSkillToken.OnEnd
struct USTBuffAction_AddSkillToken_OnEnd_Params
{
};
...
// Function Addons.STBuffCondition_IsItemInBackpack.CheckIsTrue
struct USTBuffCondition_IsItemInBackpack_CheckIsTrue_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.STBuffEvent_EnterOrLeaveVehicle.OnInitialize
struct USTBuffEvent_EnterOrLeaveVehicle_OnInitialize_Params
{
};

// Function Addons.STBuffEvent_EnterOrLeaveVehicle.OnEnterVehicle
struct USTBuffEvent_EnterOrLeaveVehicle_OnEnterVehicle_Params
{
	bool IsEnter; // (Parm, ZeroConstructor, IsPlainOldData)
	class AActor* Vehicle; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STBuffEvent_EnterOrLeaveVehicle.OnDestroy
struct USTBuffEvent_EnterOrLeaveVehicle_OnDestroy_Params
{
};
...
// Function Addons.STBuffEvent_RescueOther.OnRescueOther
struct USTBuffEvent_RescueOther_OnRescueOther_Params
{
	class APawn* SelfActor; // (Parm, ZeroConstructor, IsPlainOldData)
	class AActor* DamageCauser; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bNearDeath; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STBuffEvent_RescueOther.OnInitialize
struct USTBuffEvent_RescueOther_OnInitialize_Params
{
};

// Function Addons.STBuffEvent_RescueOther.OnDestroy
struct USTBuffEvent_RescueOther_OnDestroy_Params
{
};
...
// Function Addons.STBuffEvent_TakeDamageNotifyOnClient.OnPostTakeDamageEvent
struct USTBuffEvent_TakeDamageNotifyOnClient_OnPostTakeDamageEvent_Params
{
	float Damage; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FDamageEvent DamageEvent; // (ConstParm, Parm, OutParm, ReferenceParm)
	class AController* Controller; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STBuffEvent_TakeDamageNotifyOnClient.OnInitialize
struct USTBuffEvent_TakeDamageNotifyOnClient_OnInitialize_Params
{
};

// Function Addons.STBuffEvent_TakeDamageNotifyOnClient.OnDestroy
struct USTBuffEvent_TakeDamageNotifyOnClient_OnDestroy_Params
{
};
...
// Function Addons.STExtraBallIndicator.ShowMergedParticleSystemInBP
struct ASTExtraBallIndicator_ShowMergedParticleSystemInBP_Params
{
};

// Function Addons.STExtraBallIndicator.GetTargetDirectionMeshFromBP
struct ASTExtraBallIndicator_GetTargetDirectionMeshFromBP_Params
{
	class UStaticMeshComponent* ReturnValue; // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function Addons.STExtraBallIndicator.GetPitchRangeFromBP
struct ASTExtraBallIndicator_GetPitchRangeFromBP_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallIndicator.GetEffectMeshFromBP
struct ASTExtraBallIndicator_GetEffectMeshFromBP_Params
{
	class UStaticMeshComponent* ReturnValue; // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function Addons.STExtraBallIndicator.GetCurrentKickRotation
struct ASTExtraBallIndicator_GetCurrentKickRotation_Params
{
	class ASTExtraPlayerCharacter* PlayerCharacter; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FRotator ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallIndicator.GetCurrentDirectionMeshFromBP
struct ASTExtraBallIndicator_GetCurrentDirectionMeshFromBP_Params
{
	class UStaticMeshComponent* ReturnValue; // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function Addons.STExtraBallMovementComponent.StopMovementImmediately
struct USTExtraBallMovementComponent_StopMovementImmediately_Params
{
};

// Function Addons.STExtraBallMovementComponent.ServerUpdateInput
struct USTExtraBallMovementComponent_ServerUpdateInput_Params
{
	float FowardInput; // (Parm, ZeroConstructor, IsPlainOldData)
	float RightInput; // (Parm, ZeroConstructor, IsPlainOldData)
	float InCameraRationYaw; // (Parm, ZeroConstructor, IsPlainOldData)
	float InHandBrakeRate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallMovementComponent.ResetSimQuatFromRotator
struct USTExtraBallMovementComponent_ResetSimQuatFromRotator_Params
{
	struct FRotator InRotation; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraBallMovementComponent.PhysicsVolumeChanged
struct USTExtraBallMovementComponent_PhysicsVolumeChanged_Params
{
	class APhysicsVolume* NewVolume; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallMovementComponent.IsShouldDsControl
struct USTExtraBallMovementComponent_IsShouldDsControl_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallMovementComponent.IsLogBallVehicle
struct USTExtraBallMovementComponent_IsLogBallVehicle_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallMovementComponent.HasPower
struct USTExtraBallMovementComponent_HasPower_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallMovementComponent.GetInputDirection
struct USTExtraBallMovementComponent_GetInputDirection_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallMovementComponent.CalculVelAndInputDiff
struct USTExtraBallMovementComponent_CalculVelAndInputDiff_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.VehicleAirStateChanged
struct ASTExtraBallVehicle_VehicleAirStateChanged_Params
{
	bool bIsFoundFloor; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.UpdateEffect
struct ASTExtraBallVehicle_UpdateEffect_Params
{
};

// Function Addons.STExtraBallVehicle.TryChangeWaitingForKickState
struct ASTExtraBallVehicle_TryChangeWaitingForKickState_Params
{
	bool bReady; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.SyncClientWaterStateToServer
struct ASTExtraBallVehicle_SyncClientWaterStateToServer_Params
{
};

// Function Addons.STExtraBallVehicle.SpawnEmitterAtLocation
struct ASTExtraBallVehicle_SpawnEmitterAtLocation_Params
{
	class UParticleSystem* EmitterTemplate; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FName BoneName; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
	bool bAutoDestroy; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraBallVehicle.SpawnDeformObj_Internal
struct ASTExtraBallVehicle_SpawnDeformObj_Internal_Params
{
	struct FRotator ClientRotation; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	class ASTExtraVehicleBase* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.ShouldCalcCamera
struct ASTExtraBallVehicle_ShouldCalcCamera_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.SetPhysVelocity
struct ASTExtraBallVehicle_SetPhysVelocity_Params
{
	struct FVector Velocity; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.SetHandBrake
struct ASTExtraBallVehicle_SetHandBrake_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.SetBoosting
struct ASTExtraBallVehicle_SetBoosting_Params
{
	bool bEnalbed; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.ServerSpawnBallDeformedObj
struct ASTExtraBallVehicle_ServerSpawnBallDeformedObj_Params
{
	bool bUseCustomRotation; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FRotator InRotation; // (ConstParm, Parm, IsPlainOldData)
	class ASTExtraVehicleBase* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.STExtraBallVehicle.ServerKickVehicle
struct ASTExtraBallVehicle_ServerKickVehicle_Params
{
	struct FVector KickImpulse; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.ServerInitBallVehicle
struct ASTExtraBallVehicle_ServerInitBallVehicle_Params
{
	bool bInit; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.ServerHandleApplyImpulseByHit
struct ASTExtraBallVehicle_ServerHandleApplyImpulseByHit_Params
{
	struct FVector HitImpulse; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.RspKickVehicle
struct ASTExtraBallVehicle_RspKickVehicle_Params
{
	struct FVector KickImpulse; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.RspBoostJump
struct ASTExtraBallVehicle_RspBoostJump_Params
{
	bool bInMidAir; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.RspApplyImpulseByHit
struct ASTExtraBallVehicle_RspApplyImpulseByHit_Params
{
	struct FVector HitImpulse; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.RPC_ServerSetDeformedRotation
struct ASTExtraBallVehicle_RPC_ServerSetDeformedRotation_Params
{
	float ClientRotationYaw; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FVector VLoc; // (ConstParm, Parm, ReferenceParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.ReqServerChangeWaitingKickState
struct ASTExtraBallVehicle_ReqServerChangeWaitingKickState_Params
{
	bool bReady; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.ReqServerBoostJump
struct ASTExtraBallVehicle_ReqServerBoostJump_Params
{
};

// Function Addons.STExtraBallVehicle.RaiseBallVehicle
struct ASTExtraBallVehicle_RaiseBallVehicle_Params
{
	float DeltaHeight; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.PlayJumpCameraEffect
struct ASTExtraBallVehicle_PlayJumpCameraEffect_Params
{
	bool bInMidAir; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.PhysicsVolumeChanged
struct ASTExtraBallVehicle_PhysicsVolumeChanged_Params
{
	class APhysicsVolume* NewVolume; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.OnVehicleKicked
struct ASTExtraBallVehicle_OnVehicleKicked_Params
{
};

// Function Addons.STExtraBallVehicle.OnRep_CurrentMotionState
struct ASTExtraBallVehicle_OnRep_CurrentMotionState_Params
{
};

// Function Addons.STExtraBallVehicle.OnRep_BallInitialized
struct ASTExtraBallVehicle_OnRep_BallInitialized_Params
{
};

// Function Addons.STExtraBallVehicle.OnPlayLandEffect
struct ASTExtraBallVehicle_OnPlayLandEffect_Params
{
	class AActor* OtherActor; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector NormalImpulse; // (Parm, IsPlainOldData)
	struct FHitResult Hit; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
...
// Function Addons.STExtraBallVehicle.OnHitOther
struct ASTExtraBallVehicle_OnHitOther_Params
{
	class AActor* SelfActor; // (Parm, ZeroConstructor, IsPlainOldData)
	class AActor* OtherActor; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector NormalImpulse; // (Parm, IsPlainOldData)
...
// Function Addons.STExtraBallVehicle.OnBoostJump
struct ASTExtraBallVehicle_OnBoostJump_Params
{
};

// Function Addons.STExtraBallVehicle.MoveRight
struct ASTExtraBallVehicle_MoveRight_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.MoveForward
struct ASTExtraBallVehicle_MoveForward_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.KickVehicleInternal
struct ASTExtraBallVehicle_KickVehicleInternal_Params
{
	struct FVector Impulse; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.IsInServerAuthorizeNewInternal
struct ASTExtraBallVehicle_IsInServerAuthorizeNewInternal_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.IsBoostInMidAir
struct ASTExtraBallVehicle_IsBoostInMidAir_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.InitializeBallInternal
struct ASTExtraBallVehicle_InitializeBallInternal_Params
{
	bool bInit; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.GetRotationWithHead
struct ASTExtraBallVehicle_GetRotationWithHead_Params
{
	struct FRotator ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.GetRotationWithBone
struct ASTExtraBallVehicle_GetRotationWithBone_Params
{
	struct FName BoneName; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
	struct FRotator ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.GetRotationInputDir
struct ASTExtraBallVehicle_GetRotationInputDir_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.GetMovementInfoStr
struct ASTExtraBallVehicle_GetMovementInfoStr_Params
{
	struct FString ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function Addons.STExtraBallVehicle.GetForwardSpeed
struct ASTExtraBallVehicle_GetForwardSpeed_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.GetCurrentVelocityRotation
struct ASTExtraBallVehicle_GetCurrentVelocityRotation_Params
{
	struct FRotator ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.GetCurrentMotionState
struct ASTExtraBallVehicle_GetCurrentMotionState_Params
{
	EBallVehicleMotionState ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.GetBallMovement
struct ASTExtraBallVehicle_GetBallMovement_Params
{
	class USTExtraBallMovementComponent* ReturnValue; // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.EnterBallVehicleMotionState
struct ASTExtraBallVehicle_EnterBallVehicleMotionState_Params
{
	EBallVehicleMotionState NewState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.EnableBallCameraModifier
struct ASTExtraBallVehicle_EnableBallCameraModifier_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerCharacter* Passenger; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.ClientHandleChangeWaitingState
struct ASTExtraBallVehicle_ClientHandleChangeWaitingState_Params
{
	bool bSuccess; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraBallVehicle.ChangeWaitingForKickState
struct ASTExtraBallVehicle_ChangeWaitingForKickState_Params
{
	bool bReady; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCapsuleVehicle.VehicleBreakOutVelocity
struct ASTExtraCapsuleVehicle_VehicleBreakOutVelocity_Params
{
	struct FVector ApplyVelocity; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	bool bAddVelocity; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCapsuleVehicle.ServerBreakOut
struct ASTExtraCapsuleVehicle_ServerBreakOut_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCapsuleVehicle.MoveWheelHeight
struct ASTExtraCapsuleVehicle_MoveWheelHeight_Params
{
	float DeltaSeconds; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCapsuleVehicle.GetEnterDistanceSq
struct ASTExtraCapsuleVehicle_GetEnterDistanceSq_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraCapsuleVehicle.ForceUpdateChildTransforms
struct ASTExtraCapsuleVehicle_ForceUpdateChildTransforms_Params
{
	bool bIsPropagateFromParent; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCapsuleVehicle.EnableWheelAdjustHeight
struct ASTExtraCapsuleVehicle_EnableWheelAdjustHeight_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCapsuleVehicle.CheckAutoWakeUp
struct ASTExtraCapsuleVehicle_CheckAutoWakeUp_Params
{
};

// Function Addons.STExtraCapsuleVehicle.BreakOut
struct ASTExtraCapsuleVehicle_BreakOut_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCapsuleVehicle.BPTryCheckSimulatePhysics
struct ASTExtraCapsuleVehicle_BPTryCheckSimulatePhysics_Params
{
};

// Function Addons.STExtraCapsuleVehicle.BP_RecordValidTransform
struct ASTExtraCapsuleVehicle_BP_RecordValidTransform_Params
{
};

// Function Addons.STExtraCatapultMachineVehicle.TakeDamageWithWarehouse
struct ASTExtraCatapultMachineVehicle_TakeDamageWithWarehouse_Params
{
...
// Function Addons.STExtraCatapultMachineVehicle.SetTouchTurnDelta
struct ASTExtraCatapultMachineVehicle_SetTouchTurnDelta_Params
{
	float Delta; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCatapultMachineVehicle.SetTouchLeanDelta
struct ASTExtraCatapultMachineVehicle_SetTouchLeanDelta_Params
{
	float Delta; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCatapultMachineVehicle.ServerSetMoveInput
struct ASTExtraCatapultMachineVehicle_ServerSetMoveInput_Params
{
	float MoveForward; // (Parm, ZeroConstructor, IsPlainOldData)
	float MoveRight; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCatapultMachineVehicle.ServerResetSeat
struct ASTExtraCatapultMachineVehicle_ServerResetSeat_Params
{
};

// Function Addons.STExtraCatapultMachineVehicle.ResetSeat
struct ASTExtraCatapultMachineVehicle_ResetSeat_Params
{
};

// Function Addons.STExtraCatapultMachineVehicle.OnRep_IsResetSeat
struct ASTExtraCatapultMachineVehicle_OnRep_IsResetSeat_Params
{
};

// Function Addons.STExtraCatapultMachineVehicle.OnRep_CurStateType
struct ASTExtraCatapultMachineVehicle_OnRep_CurStateType_Params
{
};

// Function Addons.STExtraCatapultMachineVehicle.OnHasAdjustSeatChanged
struct ASTExtraCatapultMachineVehicle_OnHasAdjustSeatChanged_Params
{
};

// Function Addons.STExtraCatapultMachineVehicle.OnBPRespawned
struct ASTExtraCatapultMachineVehicle_OnBPRespawned_Params
{
};

// Function Addons.STExtraCatapultMachineVehicle.OnBPRecycled
struct ASTExtraCatapultMachineVehicle_OnBPRecycled_Params
{
};

// Function Addons.STExtraCatapultMachineVehicle.InitOriginRotation
struct ASTExtraCatapultMachineVehicle_InitOriginRotation_Params
{
	float Yaw; // (Parm, ZeroConstructor, IsPlainOldData)
	float Roll; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraCatapultMachineVehicle.GetWarehouseLocation
struct ASTExtraCatapultMachineVehicle_GetWarehouseLocation_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraCatapultMachineVehicle.ChangeState
struct ASTExtraCatapultMachineVehicle_ChangeState_Params
{
	ECatapultMachineStateType NewState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetWalkableFloorZ
struct USTExtraMyriapodVehMovementCom_SetWalkableFloorZ_Params
{
	float InWalkableFloorZ; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetWalkableFloorAngle
struct USTExtraMyriapodVehMovementCom_SetWalkableFloorAngle_Params
{
	float InWalkableFloorAngle; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetThrottleInput
struct USTExtraMyriapodVehMovementCom_SetThrottleInput_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetSteeringInput
struct USTExtraMyriapodVehMovementCom_SetSteeringInput_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetMovementMode
struct USTExtraMyriapodVehMovementCom_SetMovementMode_Params
{
	TEnumAsByte<enum EMovementMode> NewMovementMode; // (Parm, ZeroConstructor, IsPlainOldData)
	unsigned char NewCustomMode; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetGroupsToIgnoreMask
struct USTExtraMyriapodVehMovementCom_SetGroupsToIgnoreMask_Params
{
	struct FNavAvoidanceMask GroupMask; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetGroupsToIgnore
struct USTExtraMyriapodVehMovementCom_SetGroupsToIgnore_Params
{
	int GroupFlags; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetGroupsToAvoidMask
struct USTExtraMyriapodVehMovementCom_SetGroupsToAvoidMask_Params
{
	struct FNavAvoidanceMask GroupMask; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetGroupsToAvoid
struct USTExtraMyriapodVehMovementCom_SetGroupsToAvoid_Params
{
	int GroupFlags; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetAvoidanceGroupMask
struct USTExtraMyriapodVehMovementCom_SetAvoidanceGroupMask_Params
{
	struct FNavAvoidanceMask GroupMask; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetAvoidanceGroup
struct USTExtraMyriapodVehMovementCom_SetAvoidanceGroup_Params
{
	int GroupFlags; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetAvoidanceEnabled
struct USTExtraMyriapodVehMovementCom_SetAvoidanceEnabled_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.SetAcceptInput
struct USTExtraMyriapodVehMovementCom_SetAcceptInput_Params
{
	bool bIsAccept; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.ServerSetThrottleInput
struct USTExtraMyriapodVehMovementCom_ServerSetThrottleInput_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.ServerSetSteeringInput
struct USTExtraMyriapodVehMovementCom_ServerSetSteeringInput_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.ServerMoveOld
struct USTExtraMyriapodVehMovementCom_ServerMoveOld_Params
{
	float OldTimeStamp; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector_NetQuantize10 OldAccel; // (Parm)
	unsigned char OldMoveFlags; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.ServerMoveDualHybridRootMotion
struct USTExtraMyriapodVehMovementCom_ServerMoveDualHybridRootMotion_Params
{
	float TimeStamp0; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector_NetQuantize10 InAccel0; // (Parm)
	unsigned char PendingFlags; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.ServerMoveDual
struct USTExtraMyriapodVehMovementCom_ServerMoveDual_Params
{
	float TimeStamp0; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector_NetQuantize10 InAccel0; // (Parm)
	unsigned char PendingFlags; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.ServerMove
struct USTExtraMyriapodVehMovementCom_ServerMove_Params
{
	float TimeStamp; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector_NetQuantize10 InAccel; // (Parm)
	struct FVector_NetQuantize100 ClientLoc; // (Parm)
...
// Function Addons.STExtraMyriapodVehMovementCom.K2_GetWalkableFloorZ
struct USTExtraMyriapodVehMovementCom_K2_GetWalkableFloorZ_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.K2_GetWalkableFloorAngle
struct USTExtraMyriapodVehMovementCom_K2_GetWalkableFloorAngle_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.K2_GetModifiedMaxAcceleration
struct USTExtraMyriapodVehMovementCom_K2_GetModifiedMaxAcceleration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.K2_FindFloor
struct USTExtraMyriapodVehMovementCom_K2_FindFloor_Params
{
	struct FVector CapsuleLocation; // (Parm, IsPlainOldData)
	struct FFindFloorResult FloorResult; // (Parm, OutParm)
};

// Function Addons.STExtraMyriapodVehMovementCom.K2_ComputeFloorDist
struct USTExtraMyriapodVehMovementCom_K2_ComputeFloorDist_Params
{
	struct FVector CapsuleLocation; // (Parm, IsPlainOldData)
	float LineDistance; // (Parm, ZeroConstructor, IsPlainOldData)
	float SweepDistance; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.IsWalking
struct USTExtraMyriapodVehMovementCom_IsWalking_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.IsWalkable
struct USTExtraMyriapodVehMovementCom_IsWalkable_Params
{
	struct FHitResult Hit; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.IsSeriousInjuriedAllowJumping
struct USTExtraMyriapodVehMovementCom_IsSeriousInjuriedAllowJumping_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.HandleOnSeatDetached
struct USTExtraMyriapodVehMovementCom_HandleOnSeatDetached_Params
{
	class ASTExtraPlayerCharacter* Character; // (Parm, ZeroConstructor, IsPlainOldData)
	ESTExtraVehicleSeatType SeatType; // (Parm, ZeroConstructor, IsPlainOldData)
	int SeatIdx; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.HandleOnSeatChanged
struct USTExtraMyriapodVehMovementCom_HandleOnSeatChanged_Params
{
	class ASTExtraPlayerCharacter* Character; // (Parm, ZeroConstructor, IsPlainOldData)
	ESTExtraVehicleSeatType LastSeatType; // (Parm, ZeroConstructor, IsPlainOldData)
	int LastSeatIdx; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.HandleOnSeatAttached
struct USTExtraMyriapodVehMovementCom_HandleOnSeatAttached_Params
{
	class ASTExtraPlayerCharacter* Character; // (Parm, ZeroConstructor, IsPlainOldData)
	ESTExtraVehicleSeatType SeatType; // (Parm, ZeroConstructor, IsPlainOldData)
	int SeatIdx; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.GetWalkingDecResistance
struct USTExtraMyriapodVehMovementCom_GetWalkingDecResistance_Params
{
	float Speed; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetWalkingAccResistance
struct USTExtraMyriapodVehMovementCom_GetWalkingAccResistance_Params
{
	float Speed; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetValidPerchRadius
struct USTExtraMyriapodVehMovementCom_GetValidPerchRadius_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetThrottleInput
struct USTExtraMyriapodVehMovementCom_GetThrottleInput_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetSteeringInput
struct USTExtraMyriapodVehMovementCom_GetSteeringInput_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetSlopeSpeedFactor
struct USTExtraMyriapodVehMovementCom_GetSlopeSpeedFactor_Params
{
	float Speed; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetPredictVelocity
struct USTExtraMyriapodVehMovementCom_GetPredictVelocity_Params
{
	float PredictTime; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetPerchRadiusThreshold
struct USTExtraMyriapodVehMovementCom_GetPerchRadiusThreshold_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetMovementBase
struct USTExtraMyriapodVehMovementCom_GetMovementBase_Params
{
	class UPrimitiveComponent* ReturnValue; // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetMinAnalogSpeed
struct USTExtraMyriapodVehMovementCom_GetMinAnalogSpeed_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetMaxJumpHeightWithJumpTime
struct USTExtraMyriapodVehMovementCom_GetMaxJumpHeightWithJumpTime_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetMaxJumpHeight
struct USTExtraMyriapodVehMovementCom_GetMaxJumpHeight_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetMaxBrakingDeceleration
struct USTExtraMyriapodVehMovementCom_GetMaxBrakingDeceleration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetMaxAcceleration
struct USTExtraMyriapodVehMovementCom_GetMaxAcceleration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetJumpingHeightByObsHeight
struct USTExtraMyriapodVehMovementCom_GetJumpingHeightByObsHeight_Params
{
	float ObsHeight; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetJumpingHeightByCurve
struct USTExtraMyriapodVehMovementCom_GetJumpingHeightByCurve_Params
{
	float Speed; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetImpartedMovementBaseVelocity
struct USTExtraMyriapodVehMovementCom_GetImpartedMovementBaseVelocity_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetDesireAcceleration
struct USTExtraMyriapodVehMovementCom_GetDesireAcceleration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetCurrentAcceleration
struct USTExtraMyriapodVehMovementCom_GetCurrentAcceleration_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetBreakAcceleration
struct USTExtraMyriapodVehMovementCom_GetBreakAcceleration_Params
{
	float Speed; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.GetAngularVelocityByCurve
struct USTExtraMyriapodVehMovementCom_GetAngularVelocityByCurve_Params
{
	float Speed; // (Parm, ZeroConstructor, IsPlainOldData)
	bool AsForce; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.GetAnalogInputModifier
struct USTExtraMyriapodVehMovementCom_GetAnalogInputModifier_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.DisableMovement
struct USTExtraMyriapodVehMovementCom_DisableMovement_Params
{
};

// Function Addons.STExtraMyriapodVehMovementCom.ClientVeryShortAdjustPosition
struct USTExtraMyriapodVehMovementCom_ClientVeryShortAdjustPosition_Params
{
	float TimeStamp; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector NewLoc; // (Parm, IsPlainOldData)
	class UPrimitiveComponent* NewBase; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.ClientAdjustRootMotionSourcePosition
struct USTExtraMyriapodVehMovementCom_ClientAdjustRootMotionSourcePosition_Params
{
	float TimeStamp; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FRootMotionSourceGroup ServerRootMotion; // (Parm)
	bool bHasAnimRootMotion; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.ClientAdjustRootMotionPosition
struct USTExtraMyriapodVehMovementCom_ClientAdjustRootMotionPosition_Params
{
	float TimeStamp; // (Parm, ZeroConstructor, IsPlainOldData)
	float ServerMontageTrackPosition; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector ServerLoc; // (Parm, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.ClientAdjustPosition
struct USTExtraMyriapodVehMovementCom_ClientAdjustPosition_Params
{
	float TimeStamp; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector NewLoc; // (Parm, IsPlainOldData)
	struct FVector NewVel; // (Parm, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.ClientAckGoodMove
struct USTExtraMyriapodVehMovementCom_ClientAckGoodMove_Params
{
	float TimeStamp; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.ClearAccumulatedForces
struct USTExtraMyriapodVehMovementCom_ClearAccumulatedForces_Params
{
};

// Function Addons.STExtraMyriapodVehMovementCom.CapsuleTouched
struct USTExtraMyriapodVehMovementCom_CapsuleTouched_Params
{
	class UPrimitiveComponent* OverlappedComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor* Other; // (Parm, ZeroConstructor, IsPlainOldData)
	class UPrimitiveComponent* OtherComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.CalcVelocity
struct USTExtraMyriapodVehMovementCom_CalcVelocity_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
	float Friction; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bFluid; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehMovementCom.CalculateVelocityWithResistance
struct USTExtraMyriapodVehMovementCom_CalculateVelocityWithResistance_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bFluid; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.CalculateCurrentVerticalSpeed
struct USTExtraMyriapodVehMovementCom_CalculateCurrentVerticalSpeed_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.AddImpulse
struct USTExtraMyriapodVehMovementCom_AddImpulse_Params
{
	struct FVector Impulse; // (Parm, IsPlainOldData)
	bool bVelocityChange; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.AddForce
struct USTExtraMyriapodVehMovementCom_AddForce_Params
{
	struct FVector Force; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehMovementCom.AddDirectionalBrakingAcceleration
struct USTExtraMyriapodVehMovementCom_AddDirectionalBrakingAcceleration_Params
{
	struct FVector BrakingAcceleration; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraHorseMovementCom.ServerSetWalkType
struct USTExtraHorseMovementCom_ServerSetWalkType_Params
{
	EWalkType walkType1; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraHorseMovementCom.GetPredictVelocity
struct USTExtraHorseMovementCom_GetPredictVelocity_Params
{
	float PredictTime; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraHorseMovementCom.GetMaxAcceleration
struct USTExtraHorseMovementCom_GetMaxAcceleration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraHorseMovementCom.GetDesireAcceleration
struct USTExtraHorseMovementCom_GetDesireAcceleration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraHorseMovementCom.CalculateVelocityWithResistance
struct USTExtraHorseMovementCom_CalculateVelocityWithResistance_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bFluid; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.UpdatePoseCollision
struct ASTExtraMyriapodVehicle_UpdatePoseCollision_Params
{
	ESTMryiapodState CurState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.SwitchPoseStateServer
struct ASTExtraMyriapodVehicle_SwitchPoseStateServer_Params
{
	ESTMryiapodState InPoseState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.StopJumping
struct ASTExtraMyriapodVehicle_StopJumping_Params
{
};

// Function Addons.STExtraMyriapodVehicle.SetReplicateMovement
struct ASTExtraMyriapodVehicle_SetReplicateMovement_Params
{
	bool bInReplicateMovement; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.SetPlayerEnterVelocity
struct ASTExtraMyriapodVehicle_SetPlayerEnterVelocity_Params
{
};

// Function Addons.STExtraMyriapodVehicle.SetHandBrake
struct ASTExtraMyriapodVehicle_SetHandBrake_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.SetBoosting
struct ASTExtraMyriapodVehicle_SetBoosting_Params
{
	bool bEnalbed; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.ServerSetHandBrake
struct ASTExtraMyriapodVehicle_ServerSetHandBrake_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.ServerGetUp
struct ASTExtraMyriapodVehicle_ServerGetUp_Params
{
};

// Function Addons.STExtraMyriapodVehicle.ServerBrakeEnd
struct ASTExtraMyriapodVehicle_ServerBrakeEnd_Params
{
};

// Function Addons.STExtraMyriapodVehicle.SendClient_ApplyImpluse
struct ASTExtraMyriapodVehicle_SendClient_ApplyImpluse_Params
{
	EHitDir Dir; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.OnWalkingOffLedge
struct ASTExtraMyriapodVehicle_OnWalkingOffLedge_Params
{
	struct FVector PreviousFloorImpactNormal; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	struct FVector PreviousFloorContactNormal; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	struct FVector PreviousLocation; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehicle.OnTakingDamage
struct ASTExtraMyriapodVehicle_OnTakingDamage_Params
{
	class AActor* HitActor; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	class AActor* HitInstigator; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FHitResult HitInfo; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehicle.OnRep_ReplicatedBasedMovement
struct ASTExtraMyriapodVehicle_OnRep_ReplicatedBasedMovement_Params
{
};

// Function Addons.STExtraMyriapodVehicle.OnRep_PoseStateNotify
struct ASTExtraMyriapodVehicle_OnRep_PoseStateNotify_Params
{
	ESTMryiapodState InPoseState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.OnRep_MyriapodSeriousInjury
struct ASTExtraMyriapodVehicle_OnRep_MyriapodSeriousInjury_Params
{
};

// Function Addons.STExtraMyriapodVehicle.OnRep_MyriapodDead
struct ASTExtraMyriapodVehicle_OnRep_MyriapodDead_Params
{
};

// Function Addons.STExtraMyriapodVehicle.OnLaunched
struct ASTExtraMyriapodVehicle_OnLaunched_Params
{
	struct FVector LaunchVelocity; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	bool bXYOverride; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bZOverride; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehicle.OnLanded
struct ASTExtraMyriapodVehicle_OnLanded_Params
{
	struct FHitResult Hit; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.OnJumped
struct ASTExtraMyriapodVehicle_OnJumped_Params
{
};

// Function Addons.STExtraMyriapodVehicle.OnExitingVehicleOnServer
struct ASTExtraMyriapodVehicle_OnExitingVehicleOnServer_Params
{
};

// Function Addons.STExtraMyriapodVehicle.OnEnteringVehicleOnServer
struct ASTExtraMyriapodVehicle_OnEnteringVehicleOnServer_Params
{
	bool IsSucc; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.MoveUp
struct ASTExtraMyriapodVehicle_MoveUp_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.LaunchCharacter
struct ASTExtraMyriapodVehicle_LaunchCharacter_Params
{
	struct FVector LaunchVelocity; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	bool bXYOverride; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bZOverride; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehicle.K2_UpdateCustomMovement
struct ASTExtraMyriapodVehicle_K2_UpdateCustomMovement_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.K2_OnMovementModeChanged
struct ASTExtraMyriapodVehicle_K2_OnMovementModeChanged_Params
{
	TEnumAsByte<enum EMovementMode> PrevMovementMode; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EMovementMode> NewMovementMode; // (Parm, ZeroConstructor, IsPlainOldData)
	unsigned char PrevCustomMode; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraMyriapodVehicle.Jump
struct ASTExtraMyriapodVehicle_Jump_Params
{
};

// Function Addons.STExtraMyriapodVehicle.IsPlayingRootMotion
struct ASTExtraMyriapodVehicle_IsPlayingRootMotion_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.IsJumpProvidingForce
struct ASTExtraMyriapodVehicle_IsJumpProvidingForce_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.HandleOnVehicleHealthStateChanged
struct ASTExtraMyriapodVehicle_HandleOnVehicleHealthStateChanged_Params
{
	ESTExtraVehicleHealthState InVehicleHealthState; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.GetUp
struct ASTExtraMyriapodVehicle_GetUp_Params
{
};

// Function Addons.STExtraMyriapodVehicle.GetRotationInputDir
struct ASTExtraMyriapodVehicle_GetRotationInputDir_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.GetBodyShapeComponent
struct ASTExtraMyriapodVehicle_GetBodyShapeComponent_Params
{
	class UBoxComponent* ReturnValue; // (ExportObject, Parm, OutParm, ZeroConstructor, ReturnParm, InstancedReference, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.GetBaseTranslationOffset
struct ASTExtraMyriapodVehicle_GetBaseTranslationOffset_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.ExitVehicle
struct ASTExtraMyriapodVehicle_ExitVehicle_Params
{
};

// Function Addons.STExtraMyriapodVehicle.EnterVehicle
struct ASTExtraMyriapodVehicle_EnterVehicle_Params
{
	bool IsSucc; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.ClientEnterVehicle
struct ASTExtraMyriapodVehicle_ClientEnterVehicle_Params
{
	class ASTExtraPlayerCharacter* Character; // (Parm, ZeroConstructor, IsPlainOldData)
	ESTExtraVehicleSeatType SeatType; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.CanMove
struct ASTExtraMyriapodVehicle_CanMove_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.CanJumpInternal
struct ASTExtraMyriapodVehicle_CanJumpInternal_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.CanJump
struct ASTExtraMyriapodVehicle_CanJump_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.CacheInitialMeshOffset
struct ASTExtraMyriapodVehicle_CacheInitialMeshOffset_Params
{
	struct FVector MeshRelativeLocation; // (Parm, IsPlainOldData)
	struct FRotator MeshRelativeRotation; // (Parm, IsPlainOldData)
};

// Function Addons.STExtraMyriapodVehicle.BroadcastClient_TakeDamage
struct ASTExtraMyriapodVehicle_BroadcastClient_TakeDamage_Params
{
	float Damage; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FDamageEvent DamageEvent; // (ConstParm, Parm, ReferenceParm)
...
// Function Addons.STExtraMyriapodVehicle.BrakeEnd
struct ASTExtraMyriapodVehicle_BrakeEnd_Params
{
};

// Function Addons.STExtraHorseVehicle.SetWalkType
struct ASTExtraHorseVehicle_SetWalkType_Params
{
	EWalkType WalkType; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraHorseVehicle.SetHandBrake
struct ASTExtraHorseVehicle_SetHandBrake_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraHorseVehicle.SetBoosting
struct ASTExtraHorseVehicle_SetBoosting_Params
{
	bool bEnalbed; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraHorseVehicle.OnRep_HorseStateChanged
struct ASTExtraHorseVehicle_OnRep_HorseStateChanged_Params
{
};

// Function Addons.STExtraHorseVehicle.OnChangedState
struct ASTExtraHorseVehicle_OnChangedState_Params
{
	EHorseBehaviorType Type; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraHorseVehicle.MoveUp
struct ASTExtraHorseVehicle_MoveUp_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraHorseVehicle.MoveRight
struct ASTExtraHorseVehicle_MoveRight_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraHorseVehicle.MoveForward
struct ASTExtraHorseVehicle_MoveForward_Params
{
	float Rate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraHorseVehicle.Jump
struct ASTExtraHorseVehicle_Jump_Params
{
};

// Function Addons.STExtraHorseVehicle.ClientTakeDamageByShoot
struct ASTExtraHorseVehicle_ClientTakeDamageByShoot_Params
{
};

// Function Addons.STExtraLionDanceVehicle.SetEnergy
struct ASTExtraLionDanceVehicle_SetEnergy_Params
{
	float Energy; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraLionDanceVehicle.ServerRecycleVehicle
struct ASTExtraLionDanceVehicle_ServerRecycleVehicle_Params
{
};

// Function Addons.STExtraLionDanceVehicle.ServerBreakOut
struct ASTExtraLionDanceVehicle_ServerBreakOut_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraLionDanceVehicle.RspClientBreakOut
struct ASTExtraLionDanceVehicle_RspClientBreakOut_Params
{
};

// Function Addons.STExtraLionDanceVehicle.OnRep_Energy
struct ASTExtraLionDanceVehicle_OnRep_Energy_Params
{
};

// Function Addons.STExtraLionDanceVehicle.ClientRecycleVehicle
struct ASTExtraLionDanceVehicle_ClientRecycleVehicle_Params
{
};

// Function Addons.STExtraLionDanceVehicle.BreakOut
struct ASTExtraLionDanceVehicle_BreakOut_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraLionDanceVehMovementCom.GetMaxBrakingDeceleration
struct USTExtraLionDanceVehMovementCom_GetMaxBrakingDeceleration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraLionDanceVehMovementCom.GetMaxAcceleration
struct USTExtraLionDanceVehMovementCom_GetMaxAcceleration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraLionDanceVehMovementCom.CalcVelocity
struct USTExtraLionDanceVehMovementCom_CalcVelocity_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
	float Friction; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bFluid; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.STExtraLionDanceVehMovementCom.CalculateVelocityWithResistance
struct USTExtraLionDanceVehMovementCom_CalculateVelocityWithResistance_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bFluid; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMegaDropVehicle.SetNeedInitWingAvatar
struct ASTExtraMegaDropVehicle_SetNeedInitWingAvatar_Params
{
	class ASTExtraBaseCharacter* Character; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMegaDropVehicle.SendControlRotationToServer
struct ASTExtraMegaDropVehicle_SendControlRotationToServer_Params
{
};

// Function Addons.STExtraMegaDropVehicle.OnBecomeViewTarget
struct ASTExtraMegaDropVehicle_OnBecomeViewTarget_Params
{
	class APlayerController* PC; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.STExtraMegaDropVehicle.GetReplicatedRotator
struct ASTExtraMegaDropVehicle_GetReplicatedRotator_Params
{
	struct FRotator ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Addons.STExtraMegaDropVehicle.GetReplicatedLocation
struct ASTExtraMegaDropVehicle_GetReplicatedLocation_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
// Function Addons.TweenAnimComponent.StopTween
struct UTweenAnimComponent_StopTween_Params
{
	int Handle; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bGotoEnd; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.StopAllTweens
struct UTweenAnimComponent_StopAllTweens_Params
{
	bool bGotoEnd; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.ReverseTween
struct UTweenAnimComponent_ReverseTween_Params
{
	int Handle; // (Parm, ZeroConstructor, IsPlainOldData)
	float OutEstimatedTime; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.ResumeTween
struct UTweenAnimComponent_ResumeTween_Params
{
	int Handle; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.ResumeAllTweens
struct UTweenAnimComponent_ResumeAllTweens_Params
{
};

// Function Addons.TweenAnimComponent.RestartTween
struct UTweenAnimComponent_RestartTween_Params
{
	int Handle; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.RestartAllTweens
struct UTweenAnimComponent_RestartAllTweens_Params
{
};

// Function Addons.TweenAnimComponent.PlayScale
struct UTweenAnimComponent_PlayScale_Params
{
	struct FVector ToOrBy; // (Parm, IsPlainOldData)
	float Duration; // (Parm, ZeroConstructor, IsPlainOldData)
	ETweenAnimEase Ease; // (Parm, ZeroConstructor, IsPlainOldData)
	class USceneComponent* TargetComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool bBy; // (Parm, ZeroConstructor, IsPlainOldData)
	ETweenAnimLoop Loop; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.TweenAnimComponent.PlayRotate
struct UTweenAnimComponent_PlayRotate_Params
{
	struct FRotator ToOrBy; // (Parm, IsPlainOldData)
	float Duration; // (Parm, ZeroConstructor, IsPlainOldData)
	ETweenAnimEase Ease; // (Parm, ZeroConstructor, IsPlainOldData)
	class USceneComponent* TargetComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool bBy; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.TweenAnimComponent.PlayMove
struct UTweenAnimComponent_PlayMove_Params
{
	struct FVector ToOrBy; // (Parm, IsPlainOldData)
	float Duration; // (Parm, ZeroConstructor, IsPlainOldData)
	ETweenAnimEase Ease; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.TweenAnimComponent.PlayMaterialVector
struct UTweenAnimComponent_PlayMaterialVector_Params
{
	class UPrimitiveComponent* TargetMeshComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
...
// Function Addons.TweenAnimComponent.PlayMaterialScalar
struct UTweenAnimComponent_PlayMaterialScalar_Params
{
	class UPrimitiveComponent* TargetMeshComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FName ParamName; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.TweenAnimComponent.PlayCustomFloat
struct UTweenAnimComponent_PlayCustomFloat_Params
{
	float From; // (Parm, ZeroConstructor, IsPlainOldData)
	float To; // (Parm, ZeroConstructor, IsPlainOldData)
	float Duration; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.TweenAnimComponent.PauseTween
struct UTweenAnimComponent_PauseTween_Params
{
	int Handle; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.PauseAllTweens
struct UTweenAnimComponent_PauseAllTweens_Params
{
};

// Function Addons.TweenAnimComponent.IsTweenPaused
struct UTweenAnimComponent_IsTweenPaused_Params
{
	int Handle; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.IsTweenFinished
struct UTweenAnimComponent_IsTweenFinished_Params
{
	int Handle; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.IsTweenActive
struct UTweenAnimComponent_IsTweenActive_Params
{
	int Handle; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Addons.TweenAnimComponent.GetActiveTweenCount
struct UTweenAnimComponent_GetActiveTweenCount_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Addons.UAESkillAction_ActionWithEventWindow.OnSkillEvent
struct UUAESkillAction_ActionWithEventWindow_OnSkillEvent_Params
{
	int InSkillID; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.UAESkillAction_PreloadDependResource.OnAsyncLoadFinished
struct UUAESkillAction_PreloadDependResource_OnAsyncLoadFinished_Params
{
	class UActorComponent* CurComponent; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};
...
// Function Addons.UTSkillAppearance_ParticleSystem.OnSpawnParticleSystem
struct UUTSkillAppearance_ParticleSystem_OnSpawnParticleSystem_Params
{
	class UUTSkillManagerComponent* SkillManagerComponent; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UParticleSystemComponent* ParticleSystemComponent; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool bHurtParticleSystem; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Addons.VehicleSettings.ValidateCustomShapeTypes
struct UVehicleSettings_ValidateCustomShapeTypes_Params
{
	TArray<struct FString> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function Addons.VehicleSettings.LoadCustomVehicleTypes
struct UVehicleSettings_LoadCustomVehicleTypes_Params
{
};

// Function Addons.VehicleSettings.LoadCustomShapeTypes
struct UVehicleSettings_LoadCustomShapeTypes_Params
{
};
...
// Function Addons.VisualDebugComponent.OnRep_RepDebugInfoString
struct UVisualDebugComponent_OnRep_RepDebugInfoString_Params
{
};

// Function Addons.VisualDebugComponent.OnRep_BTDebugSnapshot
struct UVisualDebugComponent_OnRep_BTDebugSnapshot_Params
{
};
...
// Function Addons.VisualDebugComponent.AddDebugInfo
struct UVisualDebugComponent_AddDebugInfo_Params
{
...
// Function Addons.VisualDebugLibrary.StopBTDebug
struct UVisualDebugLibrary_StopBTDebug_Params
{
	class AAIController* AIC; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Addons.VisualDebugLibrary.RefreshBTDebugOnce
struct UVisualDebugLibrary_RefreshBTDebugOnce_Params
{
	class AAIController* AIC; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Addons.VisualDebugLibrary.MarkRefreshBTDebug
struct UVisualDebugLibrary_MarkRefreshBTDebug_Params
{
	class AAIController* AIC; // (Parm, ZeroConstructor, IsPlainOldData)
	class APlayerController* Viewer; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Addons.WaterMoveObj.OnSpecialMoveTypeChanged
struct UWaterMoveObj_OnSpecialMoveTypeChanged_Params
{
	ESpecialMovementType NewSpecialMoveType; // (Parm, ZeroConstructor, IsPlainOldData)
};
