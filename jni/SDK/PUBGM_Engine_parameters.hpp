...
{
	TEnumAsByte<enum ETickingGroup> NewTickGroup; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.ActorComponent.ReceivePostReplayRecover
struct UActorComponent_ReceivePostReplayRecover_Params
{
};
...
// Function Engine.ActorComponent.OnRep_Replicates
struct UActorComponent_OnRep_Replicates_Params
{
};
...
// Function Engine.ActorComponent.MarkNetDormancyForReplay
struct UActorComponent_MarkNetDormancyForReplay_Params
{
	bool bInDormancyForReplay; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.ActorComponent.FlushNetDormancyOnceForReplay
struct UActorComponent_FlushNetDormancyOnceForReplay_Params
{
};
...
// Function Engine.SceneComponent.SetSkipUpdateChildTransforms
struct USceneComponent_SetSkipUpdateChildTransforms_Params
{
	bool EnableSkipUpdateChildTransforms; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SceneComponent.SetSkipTransformUpdateWhenHidden
struct USceneComponent_SetSkipTransformUpdateWhenHidden_Params
{
...
struct USceneComponent_K2_AttachTo_Params
{
	class USceneComponent* InParent; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FName InSocketName; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EAttachLocation> AttachType; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bWeldSimulatedBodies; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
{
	struct FName InSocketName; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ERelativeTransformSpace> TransformSpace; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FTransform ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
// Function Engine.SceneComponent.GetSkipTransformUpdateWhenHidden
struct USceneComponent_GetSkipTransformUpdateWhenHidden_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UPrimitiveComponent_SetVisibleDyeingColor_Params
{
	struct FLinearColor InColor; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetUnderWater
struct UPrimitiveComponent_SetUnderWater_Params
{
	bool bNewUnderWater; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetTwoPassTranslucent
struct UPrimitiveComponent_SetTwoPassTranslucent_Params
{
	bool bNewTwoPassTranslucent; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.SetTranslucentSortGroupPriority
struct UPrimitiveComponent_SetTranslucentSortGroupPriority_Params
{
	int NewTranslucentSortGroupPriority; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetTranslucentDepthWriteInTwoPass
struct UPrimitiveComponent_SetTranslucentDepthWriteInTwoPass_Params
{
	bool bNewTranslucentDepthWriteInTwoPass; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetTranslucentDepthWrite
struct UPrimitiveComponent_SetTranslucentDepthWrite_Params
{
	bool bNewTranslucentDepthWrite; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.SetOverrideOccludedDyeingColorMaterial
struct UPrimitiveComponent_SetOverrideOccludedDyeingColorMaterial_Params
{
...
struct UPrimitiveComponent_SetOccludedDyeingColor_Params
{
	struct FLinearColor InColor; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.SetMaterialByNameAsyncCallBack
struct UPrimitiveComponent_SetMaterialByNameAsyncCallBack_Params
{
	struct FName MaterialSlotName; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetMaterialByNameAsync
struct UPrimitiveComponent_SetMaterialByNameAsync_Params
{
	struct FName MaterialSlotName; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FString MaterialPath; // (Parm, ZeroConstructor)
};
...
// Function Engine.PrimitiveComponent.SetMaskFilter
struct UPrimitiveComponent_SetMaskFilter_Params
{
	int InMaskFilter; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetLODDefault
struct UPrimitiveComponent_SetLODDefault_Params
{
	int LODIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface* LODMat; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetLockedAxis
struct UPrimitiveComponent_SetLockedAxis_Params
{
	TEnumAsByte<enum EDOFMode> LockedAxis; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.SetLastRenderInOpaque
struct UPrimitiveComponent_SetLastRenderInOpaque_Params
{
	bool bNewLastRenderInOpaque; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetIdeaOverrideOutlineAndOcclusion
struct UPrimitiveComponent_SetIdeaOverrideOutlineAndOcclusion_Params
{
	bool bOutlineAndOcclusion; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetIdeaOutlineUseNormalInVertexColor
struct UPrimitiveComponent_SetIdeaOutlineUseNormalInVertexColor_Params
{
	bool bNewUseNormalInVertexColor; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetIdeaOutlineOcclusionHighlight
struct UPrimitiveComponent_SetIdeaOutlineOcclusionHighlight_Params
{
	bool bOcclusionHighlight; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetIdeaOutlineOcclusionColor
struct UPrimitiveComponent_SetIdeaOutlineOcclusionColor_Params
{
	struct FLinearColor InOcclusionColor; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetIdeaOutlineNew
struct UPrimitiveComponent_SetIdeaOutlineNew_Params
{
	bool bNew; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetHighlightCanBeOccluded
struct UPrimitiveComponent_SetHighlightCanBeOccluded_Params
{
...
// Function Engine.PrimitiveComponent.SetDyeingColorMinMaxDistance
struct UPrimitiveComponent_SetDyeingColorMinMaxDistance_Params
{
	float InMinDistance; // (Parm, ZeroConstructor, IsPlainOldData)
	float InMaxDistance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetDyeingColorFadeDistance
struct UPrimitiveComponent_SetDyeingColorFadeDistance_Params
{
	float InFadeDistance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetDrawIdeaOutline
struct UPrimitiveComponent_SetDrawIdeaOutline_Params
{
	bool bNewDrawOutline; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetDrawHighlight
struct UPrimitiveComponent_SetDrawHighlight_Params
{
	bool bNewDrawHighlight; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetDrawDyeingMode
struct UPrimitiveComponent_SetDrawDyeingMode_Params
{
	EDrawDyeingMode InDrawDyeingMode; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetDrawDyeing
struct UPrimitiveComponent_SetDrawDyeing_Params
{
	bool bNewDrawOutline; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum EDOFMode> ConstraintMode; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum ECollisionEnabled> NewType; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UPrimitiveComponent_SetCastPhotonShadow_Params
{
	bool bNewCastPhotonShadow; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.SetAllowCullDistanceVolume
struct UPrimitiveComponent_SetAllowCullDistanceVolume_Params
{
	bool bNewAllowCullDistanceVolume; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.SetAfterSeparateTransparencyFlag
struct UPrimitiveComponent_SetAfterSeparateTransparencyFlag_Params
{
	bool flag; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.SetAffectAO
struct UPrimitiveComponent_SetAffectAO_Params
{
	bool bNewAffectAO; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UPrimitiveComponent_OverrideIdeaOutlineThickness_Params
{
...
struct UPrimitiveComponent_OverrideIdeaOutlineColor_Params
{
	bool bOverride; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UPrimitiveComponent_OverrideHighlightColor_Params
{
	bool bOverride; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FLinearColor InHighlightColor; // (Parm, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.ModifyCollision
struct UPrimitiveComponent_ModifyCollision_Params
{
	TEnumAsByte<enum ECollisionEnabled> NewType; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.K2_SetMoveIgnoreMask
struct UPrimitiveComponent_K2_SetMoveIgnoreMask_Params
{
	int InIgnoreMask; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.K2_IsTriggerCollisionEnabled
struct UPrimitiveComponent_K2_IsTriggerCollisionEnabled_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.K2_GetMoveIgnoreMask
struct UPrimitiveComponent_K2_GetMoveIgnoreMask_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.GetMaterialAsync
struct UPrimitiveComponent_GetMaterialAsync_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate MaterialCallback; // (Parm, ZeroConstructor)
	class UMaterialInterface* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.GetMaskFilter
struct UPrimitiveComponent_GetMaskFilter_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.GetLocalCenterOfMass
struct UPrimitiveComponent_GetLocalCenterOfMass_Params
{
	struct FName BoneName; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
{
	TEnumAsByte<enum ECollisionChannel> Channel; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ECollisionResponse> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
{
	TEnumAsByte<enum ECollisionChannel> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.GetCollisionEnabled
struct UPrimitiveComponent_GetCollisionEnabled_Params
{
	TEnumAsByte<enum ECollisionEnabled> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.PrimitiveComponent.ForceRecoverMaterial
struct UPrimitiveComponent_ForceRecoverMaterial_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.ForceClearMaterial
struct UPrimitiveComponent_ForceClearMaterial_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PrimitiveComponent.CreateDynamicMaterialInstanceAsync
struct UPrimitiveComponent_CreateDynamicMaterialInstanceAsync_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate MaterialInstCallback; // (Parm, ZeroConstructor)
...
// Function Engine.PrimitiveComponent.CreateAndSetMaterialInstanceDynamicFromMaterialAsync
struct UPrimitiveComponent_CreateAndSetMaterialInstanceDynamicFromMaterialAsync_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.PrimitiveComponent.CreateAndSetMaterialInstanceDynamicAsync
struct UPrimitiveComponent_CreateAndSetMaterialInstanceDynamicAsync_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate MaterialInstCallback; // (Parm, ZeroConstructor)
	class UMaterialInstanceDynamic* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// DelegateFunction Engine.PrimitiveComponent.ComponentTriggeredBySignature__DelegateSignature
struct UPrimitiveComponent_ComponentTriggeredBySignature__DelegateSignature_Params
{
...
// DelegateFunction Engine.PrimitiveComponent.ComponentPhysicsContactSignature__DelegateSignature
struct UPrimitiveComponent_ComponentPhysicsContactSignature__DelegateSignature_Params
{
	class AActor* OtherActor; // (Parm, ZeroConstructor, IsPlainOldData)
	class UPrimitiveComponent* OtherComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	EPhysicsContactState ContactState; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector NormalImpulse; // (Parm, IsPlainOldData)
	struct FHitResult Hit; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// DelegateFunction Engine.PrimitiveComponent.ComponentInteractWithTriggerSignature__DelegateSignature
struct UPrimitiveComponent_ComponentInteractWithTriggerSignature__DelegateSignature_Params
{
	class AActor* TriggerActor; // (Parm, ZeroConstructor, IsPlainOldData)
	class UPrimitiveComponent* TriggerComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FTriggerEvent TriggerEvent; // (ConstParm, Parm, OutParm, ReferenceParm)
};
...
struct UPrimitiveComponent_AddRadialImpulse_Params
{
	...
	TEnumAsByte<enum ERadialImpulseFalloff> Falloff; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UMeshComponent_SetUseOverlayMaterials_Params
{
	bool bNewUseOverlayMaterials; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetUseIndexedOverlayMaterials
struct UMeshComponent_SetUseIndexedOverlayMaterials_Params
{
	bool bNewUseIndexedOverlayMaterials; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.MeshComponent.SetRenderInCustomPass
struct UMeshComponent_SetRenderInCustomPass_Params
{
	bool InRenderInCustomPass; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	float InMaxDrawDistance; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetOverlayMaterial
struct UMeshComponent_SetOverlayMaterial_Params
{
	class UMaterialInterface* NewOverlayMaterial; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetLayerVisibilityValue
struct UMeshComponent_SetLayerVisibilityValue_Params
{
	TEnumAsByte<enum EMeshVisibleLayer> Layer; // (Parm, ZeroConstructor, IsPlainOldData)
	bool Visible; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bPropagateToChildren; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetLayerVisibilityEnable
struct UMeshComponent_SetLayerVisibilityEnable_Params
{
	bool Enable; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bPropagateToChildren; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetLayerCastShadowValue
struct UMeshComponent_SetLayerCastShadowValue_Params
{
	TEnumAsByte<enum EMeshCastShadowLayer> Layer; // (Parm, ZeroConstructor, IsPlainOldData)
	bool NewCastShadow; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetLayerCastShadowEnable
struct UMeshComponent_SetLayerCastShadowEnable_Params
{
	bool Enable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetIsHeadMesh
struct UMeshComponent_SetIsHeadMesh_Params
{
	bool InIsHeadMesh; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetIndexedOverlayMaterial
struct UMeshComponent_SetIndexedOverlayMaterial_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface* Material; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetForceSyncCreatePSO
struct UMeshComponent_SetForceSyncCreatePSO_Params
{
	bool InForceSyncCreatePSO; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetFeatureMaterial
struct UMeshComponent_SetFeatureMaterial_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface* Material; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetDrawStyle
struct UMeshComponent_SetDrawStyle_Params
{
	TEnumAsByte<enum EDrawStyleMode> InDrawStyle; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.SetCastShadow
struct UMeshComponent_SetCastShadow_Params
{
	bool NewCastShadow; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UMeshComponent_GetUseOverlayMaterials_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.MeshComponent.GetUseIndexedOverlayMaterials
struct UMeshComponent_GetUseIndexedOverlayMaterials_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.MeshComponent.GetRenderInCustomPass
struct UMeshComponent_GetRenderInCustomPass_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.MeshComponent.GetLayerVisibilityValue
struct UMeshComponent_GetLayerVisibilityValue_Params
{
	TEnumAsByte<enum EMeshVisibleLayer> Layer; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.MeshComponent.GetLayerCastShadowValue
struct UMeshComponent_GetLayerCastShadowValue_Params
{
	TEnumAsByte<enum EMeshCastShadowLayer> Layer; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.MeshComponent.GetIsHideBySmartBear
struct UMeshComponent_GetIsHideBySmartBear_Params
{
	TEnumAsByte<enum EMeshVisibleLayer> Layer; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.MeshComponent.GetIsHeadMesh
struct UMeshComponent_GetIsHeadMesh_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.MeshComponent.GetIndexedOverlayMaterials
struct UMeshComponent_GetIndexedOverlayMaterials_Params
{
	TArray<class UMaterialInterface*> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function Engine.MeshComponent.GetForceSyncCreatePSO
struct UMeshComponent_GetForceSyncCreatePSO_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.MeshComponent.GetDrawStyle
struct UMeshComponent_GetDrawStyle_Params
{
	TEnumAsByte<enum EDrawStyleMode> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.MeshComponent.EnableMeshClipPlane
struct UMeshComponent_EnableMeshClipPlane_Params
{
	struct FPlane ClipPlane; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	int PlaneIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.EnableMeshClipArc
struct UMeshComponent_EnableMeshClipArc_Params
{
	struct FPlane ClipPlane; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	struct FVector4 ClipSphere; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Engine.MeshComponent.EnableMeshClip4Planes
struct UMeshComponent_EnableMeshClip4Planes_Params
{
	TArray<struct FPlane> ClipPlanes; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bBox; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.DisableMeshClipPlane
struct UMeshComponent_DisableMeshClipPlane_Params
{
	int PlaneIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.DisableMeshClipArc
struct UMeshComponent_DisableMeshClipArc_Params
{
};

// Function Engine.MeshComponent.DisableMeshClip4Planes
struct UMeshComponent_DisableMeshClip4Planes_Params
{
};

// Function Engine.MeshComponent.ClearFeatureMaterial
struct UMeshComponent_ClearFeatureMaterial_Params
{
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.MeshComponent.ClearAllFeatureMaterial
struct UMeshComponent_ClearAllFeatureMaterial_Params
{
};
...
// Function Engine.SkinnedMeshComponent.SetRenderInCustomPass
struct USkinnedMeshComponent_SetRenderInCustomPass_Params
{
	bool InRenderInCustomPass; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.SkinnedMeshComponent.SetIsHeadMesh
struct USkinnedMeshComponent_SetIsHeadMesh_Params
{
	bool InIsHeadMesh; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkinnedMeshComponent.SetGlobalUROExcludeFlags
struct USkinnedMeshComponent_SetGlobalUROExcludeFlags_Params
{
	EGlobalUROExcludeFlags Flags; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkinnedMeshComponent.SetForceSyncCreatePSO
struct USkinnedMeshComponent_SetForceSyncCreatePSO_Params
{
	bool InForceSyncCreatePSO; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.SkinnedMeshComponent.SetDrawStyle
struct USkinnedMeshComponent_SetDrawStyle_Params
{
	TEnumAsByte<enum EDrawStyleMode> InDrawStyle; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.SkinnedMeshComponent.ResetAnimUROParams
struct USkinnedMeshComponent_ResetAnimUROParams_Params
{
	TArray<float> DistanceFactors; // (Parm, ZeroConstructor)
	int MaxEvalRateForInterpolation; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FName BoneName; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EPhysBodyOp> PhysBodyOption; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.SkinnedMeshComponent.GetRenderInCustomPass
struct USkinnedMeshComponent_GetRenderInCustomPass_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.SkinnedMeshComponent.GetIsHeadMesh
struct USkinnedMeshComponent_GetIsHeadMesh_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkinnedMeshComponent.GetGlobalUROExcludeFlags
struct USkinnedMeshComponent_GetGlobalUROExcludeFlags_Params
{
	EGlobalUROExcludeFlags ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkinnedMeshComponent.GetForceSyncCreatePSO
struct USkinnedMeshComponent_GetForceSyncCreatePSO_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkinnedMeshComponent.GetDrawStyle
struct USkinnedMeshComponent_GetDrawStyle_Params
{
	TEnumAsByte<enum EDrawStyleMode> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct USkinnedMeshComponent_EnableMeshClipPlane_Params
{
	struct FPlane ClipPlane; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	int PlaneIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct USkinnedMeshComponent_EnableMeshClipArc_Params
{
	struct FPlane ClipPlane; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	struct FVector4 ClipSphere; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};
...
struct USkinnedMeshComponent_EnableMeshClip4Planes_Params
{
	TArray<struct FPlane> ClipPlanes; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bBox; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct USkinnedMeshComponent_DisableMeshClipPlane_Params
{
	int PlaneIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkinnedMeshComponent.DisableMeshClipArc
struct USkinnedMeshComponent_DisableMeshClipArc_Params
{
};

// Function Engine.SkinnedMeshComponent.DisableMeshClip4Planes
struct USkinnedMeshComponent_DisableMeshClip4Planes_Params
{
};
...
// Function Engine.SkeletalMeshComponent.StartClothSimulationWithDelay
struct USkeletalMeshComponent_StartClothSimulationWithDelay_Params
{
	int DelayFrames; // (Parm, ZeroConstructor, IsPlainOldData)
	int ResumeBlendFrames; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.SkeletalMeshComponent.SetTickMode
struct USkeletalMeshComponent_SetTickMode_Params
{
	ESkeletaTickMode InTickMode; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.SkeletalMeshComponent.SetSubInstance
struct USkeletalMeshComponent_SetSubInstance_Params
{
...
// Function Engine.SkeletalMeshComponent.SetClothSkinningMode
struct USkeletalMeshComponent_SetClothSkinningMode_Params
{
	int ClothAssetIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	EClothSkinningMode InMode; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.SetClothResumeBlendFrames
struct USkeletalMeshComponent_SetClothResumeBlendFrames_Params
{
...
// Function Engine.SkeletalMeshComponent.SetClothAnimDriveStiffnessRange
struct USkeletalMeshComponent_SetClothAnimDriveStiffnessRange_Params
{
	float InLow; // (Parm, ZeroConstructor, IsPlainOldData)
	float InHigh; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.SetClothAnimDriveMultiplier
struct USkeletalMeshComponent_SetClothAnimDriveMultiplier_Params
{
	float InMultiplier; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.SetClothAnimDriveMaxRelativeVelocity
struct USkeletalMeshComponent_SetClothAnimDriveMaxRelativeVelocity_Params
{
	float InVelocity; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.SetClothAnimDriveEnabled
struct USkeletalMeshComponent_SetClothAnimDriveEnabled_Params
{
	bool bInEnabled; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.SetClothAnimDriveDampingRange
struct USkeletalMeshComponent_SetClothAnimDriveDampingRange_Params
{
	float InLow; // (Parm, ZeroConstructor, IsPlainOldData)
	float InHigh; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.SkeletalMeshComponent.SetAnimGroupRole
struct USkeletalMeshComponent_SetAnimGroupRole_Params
{
	ESkeletalMeshGroupRole NewRole; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.SetAnimationMode
struct USkeletalMeshComponent_SetAnimationMode_Params
{
	TEnumAsByte<enum EAnimationMode> InAnimationMode; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.SkeletalMeshComponent.ResetClothSimulationDelay
struct USkeletalMeshComponent_ResetClothSimulationDelay_Params
{
};

// Function Engine.SkeletalMeshComponent.ResetClothAnimDriveRuntimeOverrides
struct USkeletalMeshComponent_ResetClothAnimDriveRuntimeOverrides_Params
{
};
...
// Function Engine.SkeletalMeshComponent.GetSubInstance
struct USkeletalMeshComponent_GetSubInstance_Params
{
	struct FName InTag; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
...
// Function Engine.SkeletalMeshComponent.GetContainerObject
struct USkeletalMeshComponent_GetContainerObject_Params
{
	struct FName InTag; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
	class UAnimInstanceContainer* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.GetClothSkinningMode
struct USkeletalMeshComponent_GetClothSkinningMode_Params
{
	int ClothAssetIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	EClothSkinningMode ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.SkeletalMeshComponent.GetClothAnimDriveStiffnessRange
struct USkeletalMeshComponent_GetClothAnimDriveStiffnessRange_Params
{
	float OutLow; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
	float OutHigh; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.GetClothAnimDriveMultiplier
struct USkeletalMeshComponent_GetClothAnimDriveMultiplier_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.GetClothAnimDriveMaxRelativeVelocity
struct USkeletalMeshComponent_GetClothAnimDriveMaxRelativeVelocity_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.GetClothAnimDriveEnabled
struct USkeletalMeshComponent_GetClothAnimDriveEnabled_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.GetClothAnimDriveDampingRange
struct USkeletalMeshComponent_GetClothAnimDriveDampingRange_Params
{
	float OutLow; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
	float OutHigh; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum EAnimationMode> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.SkeletalMeshComponent.EnableCheckPhysicsBounds
struct USkeletalMeshComponent_EnableCheckPhysicsBounds_Params
{
	bool InEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.SkeletalMeshComponent.ClearSubInstance
struct USkeletalMeshComponent_ClearSubInstance_Params
{
	struct FName InTag; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
};
...
// Function Engine.SkeletalMeshComponent.ClearContainerObjects
struct USkeletalMeshComponent_ClearContainerObjects_Params
{
};

// Function Engine.SkeletalMeshComponent.CacheContainerObject
struct USkeletalMeshComponent_CacheContainerObject_Params
{
	struct FName InTag; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
	class UAnimInstanceContainer* InContainerObject; // (Parm, ZeroConstructor, IsPlainOldData)
	class UAnimInstance* OwnerInstance; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.AnimInstance.SetSubAnimNodeAnimInstance
struct UAnimInstance_SetSubAnimNodeAnimInstance_Params
{
	struct FName SubInstanceSlotName; // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	TEnumAsByte<enum ERootMotionMode> Value; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.AnimInstance.SetForceParallelUpdateAnimation
struct UAnimInstance_SetForceParallelUpdateAnimation_Params
{
...
// Function Engine.AnimInstance.ResetSubAnimNodeAnimInstance
struct UAnimInstance_ResetSubAnimNodeAnimInstance_Params
{
	struct FName SubInstanceSlotName; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.AnimInstance.Montage_GetNextSection
struct UAnimInstance_Montage_GetNextSection_Params
{
	class UAnimMontage* Montage; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FName SectionName; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FName ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Engine.AnimInstance.GetSubAnimNodeAnimInstance
struct UAnimInstance_GetSubAnimNodeAnimInstance_Params
{
	struct FName SubInstanceSlotName; // (Parm, ZeroConstructor, IsPlainOldData)
	class UAnimInstance* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.AnimInstance.GetCurMontageBySlot
struct UAnimInstance_GetCurMontageBySlot_Params
{
	struct FName SlotName; // (Parm, ZeroConstructor, IsPlainOldData)
	class UAnimMontage* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimInstance.DestroySubAnimInstance
struct UAnimInstance_DestroySubAnimInstance_Params
{
	class UAnimInstance* AnimInstance; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimInstance.DestroyAllSubAnimInstances
struct UAnimInstance_DestroyAllSubAnimInstances_Params
{
};

// Function Engine.AnimInstance.CreateSubAnimInstance
struct UAnimInstance_CreateSubAnimInstance_Params
{
	class UClass* InstanceClass; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.Actor.SetParallelWorldId
struct AActor_SetParallelWorldId_Params
{
	int InWorldId; // (Parm, ZeroConstructor, IsPlainOldData)
	int Masks; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.Actor.SetNetUpdateGroupID
struct AActor_SetNetUpdateGroupID_Params
{
	unsigned char InGroupID; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.Actor.SetNetUpdateGroup
struct AActor_SetNetUpdateGroup_Params
{
	class AActor* InConnectionActor; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.Actor.SetNetDormancy
struct AActor_SetNetDormancy_Params
{
	TEnumAsByte<enum ENetDormancy> NewDormancy; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.Actor.ResetParallelWorldId
struct AActor_ResetParallelWorldId_Params
{
	int Masks; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.Actor.ReceiveReInitForReplay
struct AActor_ReceiveReInitForReplay_Params
{
};
...
// Function Engine.Actor.ReceivePostReplayRecover
struct AActor_ReceivePostReplayRecover_Params
{
};
...
{
	TEnumAsByte<enum ETouchIndex> FingerIndex; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.Actor.MarkNetDormancyForReplay
struct AActor_MarkNetDormancyForReplay_Params
{
	bool bInDormancyForReplay; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bForceNetUpdate; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct AActor_K2_AttachRootComponentToActor_Params
{
	class AActor* InParentActor; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FName InSocketName; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EAttachLocation> AttachLocationType; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bWeldSimulatedBodies; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.Actor.GetParallelWorldId
struct AActor_GetParallelWorldId_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.Actor.GetNetUpdateGroupID
struct AActor_GetNetUpdateGroupID_Params
{
...
// Function Engine.Actor.FlushNetDormancyOnceForReplay
struct AActor_FlushNetDormancyOnceForReplay_Params
{
};
...
// Function Engine.Actor.ClearComponentOverlaps
struct AActor_ClearComponentOverlaps_Params
{
};

// Function Engine.Actor.BeenInParallelWorld
struct AActor_BeenInParallelWorld_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// DelegateFunction Engine.Actor.ActorTriggeredBySignature__DelegateSignature
struct AActor_ActorTriggeredBySignature__DelegateSignature_Params
{
	class AActor* OtherActor; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FTriggerEvent TriggerEvent; // (ConstParm, Parm, OutParm, ReferenceParm)
};

// DelegateFunction Engine.Actor.ActorPhysicsContactSignature__DelegateSignature
struct AActor_ActorPhysicsContactSignature__DelegateSignature_Params
{
	class AActor* OtherActor; // (Parm, ZeroConstructor, IsPlainOldData)
	EPhysicsContactState ContactState; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FVector NormalImpulse; // (Parm, IsPlainOldData)
...
// DelegateFunction Engine.Actor.ActorInteractWithTriggerSignature__DelegateSignature
struct AActor_ActorInteractWithTriggerSignature__DelegateSignature_Params
{
	class AActor* TriggerActor; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FTriggerEvent TriggerEvent; // (ConstParm, Parm, OutParm, ReferenceParm)
};
...
// Function Engine.Pawn.GetMovementBase
struct APawn_GetMovementBase_Params
{
...
// Function Engine.Character.OnRep_ServerLastTransformUpdateTimeStamp
struct ACharacter_OnRep_ServerLastTransformUpdateTimeStamp_Params
{
};
...
{
	struct FRotator NewRotation; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	struct FString CallSource; // (Parm, ZeroConstructor)
};
...
// Function Engine.Controller.PossessOnlyClient
struct AController_PossessOnlyClient_Params
{
...
{
	TEnumAsByte<enum ETravelFailure> FailureType; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.GameInstance.HandleNetworkError
struct UGameInstance_HandleNetworkError_Params
{
	TEnumAsByte<enum ENetworkFailure> FailureType; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bIsServer; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.GameInstance.GetDeviceLevel
struct UGameInstance_GetDeviceLevel_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct USplineComponent_SetUpVectorAtSplinePoint_Params
{
	...
	TEnumAsByte<enum ESplineCoordinateSpace> CoordinateSpace; // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	int PointIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ESplinePointType> Type; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bUpdateSpline; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	int PointIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ESplinePointType> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.SplineComponent.GetLocationAndRotationAtDistanceAlongSpline
struct USplineComponent_GetLocationAndRotationAtDistanceAlongSpline_Params
{
	struct FRotator OutRotation; // (Parm, OutParm, IsPlainOldData)
	float Distance; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ESplineCoordinateSpace> CoordinateSpace; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.SplineComponent.GetCurvatureAtSplinePoint
struct USplineComponent_GetCurvatureAtSplinePoint_Params
{
	int PointIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SplineComponent.GetCurvatureAtDistance
struct USplineComponent_GetCurvatureAtDistance_Params
{
	float Distance; // (Parm, ZeroConstructor, IsPlainOldData)
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
{
	TEnumAsByte<enum ECameraProjectionMode> InProjectionMode; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.CameraComponent.SetAutoFixFovByAspectRatio
struct UCameraComponent_SetAutoFixFovByAspectRatio_Params
{
	bool bInAutoFixFovByAspectRatio; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.CameraComponent.OnViewportSizeChanged
struct UCameraComponent_OnViewportSizeChanged_Params
{
...
struct UParticleSystemComponent_SetTrailSourceData_Params
{
	...
	TEnumAsByte<enum ETrailWidthMode> InWidthMode; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.ParticleSystemComponent.SetSocketName
struct UParticleSystemComponent_SetSocketName_Params
{
	struct FName InSocketName; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.ParticleSystemComponent.SetMultiCurveActiveIndex
struct UParticleSystemComponent_SetMultiCurveActiveIndex_Params
{
	struct FName ParameterName; // (Parm, ZeroConstructor, IsPlainOldData)
	int ActiveIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bNeedResetParticles; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	int InLODLevel; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.ParticleSystemComponent.OnMaterialLoaded
struct UParticleSystemComponent_OnMaterialLoaded_Params
{
	class UMaterialInterface* MaterialInstance; // (Parm, ZeroConstructor, IsPlainOldData)
	int ElementIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.ParticleSystemComponent.GetTemplate
struct UParticleSystemComponent_GetTemplate_Params
{
...
// Function Engine.ParticleSystemComponent.CreateNamedDynamicMaterialInstanceAsync
struct UParticleSystemComponent_CreateNamedDynamicMaterialInstanceAsync_Params
{
	struct FName InName; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate MaterialInstCallback; // (Parm, ZeroConstructor)
	class UMaterialInterface* SourceMaterial; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.DecalBakingActor.SetMaxDecalProcessPerFame
struct ADecalBakingActor_SetMaxDecalProcessPerFame_Params
{
	int InValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DecalBakingActor.OnBakingFinished
struct ADecalBakingActor_OnBakingFinished_Params
{
	class UTextureRenderTarget2D* InRenderTarget; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DecalBakingActor.GetMaxDecalProcessPerFame
struct ADecalBakingActor_GetMaxDecalProcessPerFame_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.DecalBakingActor.FindDecalBakingRequestID
struct ADecalBakingActor_FindDecalBakingRequestID_Params
{
	class UTextureRenderTarget2D* RenderTarget; // (Parm, ZeroConstructor, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.DecalBakingActor.EndDecalBakingCache
struct ADecalBakingActor_EndDecalBakingCache_Params
{
	class UTextureRenderTarget2D* RenderTarget; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DecalBakingActor.DoCompression
struct ADecalBakingActor_DoCompression_Params
{
	class UTextureRenderTarget2D* InRenderTarget; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DecalBakingActor.CompressTexture
struct ADecalBakingActor_CompressTexture_Params
{
	class UTextureRenderTarget2D* InRenderTarget; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bInRGBA; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bUsePunchthroughAlpha; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bUseOptimizeOpaque; // (Parm, ZeroConstructor, IsPlainOldData)
	class UTexture* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.DecalBakingActor.CancelDecalBakingRequest
struct ADecalBakingActor_CancelDecalBakingRequest_Params
{
	int RequestID; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DecalBakingActor.BeginDecalBakingCache
struct ADecalBakingActor_BeginDecalBakingCache_Params
{
	class UTextureRenderTarget2D* RenderTarget; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DecalBakingActor.BakeDecalForStaticMesh
struct ADecalBakingActor_BakeDecalForStaticMesh_Params
{
	class UTextureRenderTarget2D* RenderTarget; // (Parm, ZeroConstructor, IsPlainOldData)
	class UStaticMesh* StaticMesh; // (Parm, ZeroConstructor, IsPlainOldData)
	int UVIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	TArray<struct FDecalParameter> InDecalParams; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bIntermidiate; // (Parm, ZeroConstructor, IsPlainOldData)
	int CachedDecalIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.DecalBakingActor.BakeDecalForSkeletalMesh
struct ADecalBakingActor_BakeDecalForSkeletalMesh_Params
{
	class UTextureRenderTarget2D* RenderTarget; // (Parm, ZeroConstructor, IsPlainOldData)
	...
	class UTexture* OriginTexture; // (Parm, ZeroConstructor, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.StaticMeshComponent.SetRenderInCustomPass
struct UStaticMeshComponent_SetRenderInCustomPass_Params
{
	bool InRenderInCustomPass; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.SetOverrideCullingScreenSizeEnable
struct UStaticMeshComponent_SetOverrideCullingScreenSizeEnable_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.SetOverrideCullingScreenSize
struct UStaticMeshComponent_SetOverrideCullingScreenSize_Params
{
	float ScreenSize; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.SetLowDeviceForcedLodModel
struct UStaticMeshComponent_SetLowDeviceForcedLodModel_Params
{
	int NewLowDeviceForcedLodModel; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.SetForceSyncCreatePSO
struct UStaticMeshComponent_SetForceSyncCreatePSO_Params
{
	bool InForceSyncCreatePSO; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.StaticMeshComponent.SetDrawStyle
struct UStaticMeshComponent_SetDrawStyle_Params
{
	TEnumAsByte<enum EDrawStyleMode> InDrawStyle; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.StaticMeshComponent.GetRenderInCustomPass
struct UStaticMeshComponent_GetRenderInCustomPass_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.StaticMeshComponent.GetForceSyncCreatePSO
struct UStaticMeshComponent_GetForceSyncCreatePSO_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.GetDrawStyle
struct UStaticMeshComponent_GetDrawStyle_Params
{
	TEnumAsByte<enum EDrawStyleMode> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.EnableMeshClipPlane
struct UStaticMeshComponent_EnableMeshClipPlane_Params
{
	struct FPlane ClipPlane; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	int PlaneIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.EnableMeshClipArc
struct UStaticMeshComponent_EnableMeshClipArc_Params
{
	struct FPlane ClipPlane; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	struct FVector4 ClipSphere; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.EnableMeshClip4Planes
struct UStaticMeshComponent_EnableMeshClip4Planes_Params
{
	TArray<struct FPlane> ClipPlanes; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bBox; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.DisableMeshClipPlane
struct UStaticMeshComponent_DisableMeshClipPlane_Params
{
	int PlaneIndex; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StaticMeshComponent.DisableMeshClipArc
struct UStaticMeshComponent_DisableMeshClipArc_Params
{
};

// Function Engine.StaticMeshComponent.DisableMeshClip4Planes
struct UStaticMeshComponent_DisableMeshClip4Planes_Params
{
};
...
// Function Engine.CharacterMovementComponent.FlushServerMoves
struct UCharacterMovementComponent_FlushServerMoves_Params
{
};
...
// Function Engine.NetDriver.SetFunctionEligibleForSharedSerializationByName
struct UNetDriver_SetFunctionEligibleForSharedSerializationByName_Params
{
	class UClass* Class; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FString FunctionName; // (Parm, ZeroConstructor)
	bool bEligible; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.NetDriver.PrintRPCFunctionCallInfo
struct UNetDriver_PrintRPCFunctionCallInfo_Params
{
};
...
// Function Engine.GameplayStatics.UnloadAllStreamLevel
struct UGameplayStatics_UnloadAllStreamLevel_Params
{
	class UObject* WorldContextObject; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.GameplayStatics.SpawnEmitterAttachedToActor
struct UGameplayStatics_SpawnEmitterAttachedToActor_Params
{
...
// Function Engine.GameplayStatics.RestartShaderPrecompile
struct UGameplayStatics_RestartShaderPrecompile_Params
{
};
...
// Function Engine.GameplayStatics.OpenShaderCodeLibrary
struct UGameplayStatics_OpenShaderCodeLibrary_Params
{
...
{
	struct FHitResult Hit; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	TEnumAsByte<enum EPhysicalSurface> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.GameplayStatics.GetPlatformInt
struct UGameplayStatics_GetPlatformInt_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UGameplayStatics_GetFirstActorOfClass_Params
{
	class UObject* WorldContextObject; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.GameplayStatics.FlushAsyncLoading
struct UGameplayStatics_FlushAsyncLoading_Params
{
};
...
// Function Engine.GameplayStatics.EnableShaderPak_Only
struct UGameplayStatics_EnableShaderPak_Only_Params
{
	struct FString ShaderPakName; // (Parm, ZeroConstructor)
};

// Function Engine.GameplayStatics.EnableShaderPak
struct UGameplayStatics_EnableShaderPak_Params
{
	struct FString ShaderPakName; // (Parm, ZeroConstructor)
};

// Function Engine.GameplayStatics.EnableShaderLevel
struct UGameplayStatics_EnableShaderLevel_Params
{
	struct FString ShaderLevelName; // (Parm, ZeroConstructor)
};

// Function Engine.GameplayStatics.EnableShaderGroup
struct UGameplayStatics_EnableShaderGroup_Params
{
	struct FString GroupName; // (Parm, ZeroConstructor)
	int ShaderPlatform; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.GameplayStatics.CheckMetalLibraryUncompressed
struct UGameplayStatics_CheckMetalLibraryUncompressed_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UGameplayStatics_Blueprint_PredictProjectilePath_ByTraceChannel_Params
{
	...
	TEnumAsByte<enum ECollisionChannel> TraceChannel; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bTraceComplex; // (Parm, ZeroConstructor, IsPlainOldData)
	TArray<class AActor*> ActorsToIgnore; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TEnumAsByte<enum EDrawDebugTrace> DrawDebugType; // (Parm, ZeroConstructor, IsPlainOldData)
	...
	float IgnoreGravityDis; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.GameplayStatics.Blueprint_PredictBulletPath_ByTraceChannel
struct UGameplayStatics_Blueprint_PredictBulletPath_ByTraceChannel_Params
{
	class UObject* WorldContextObject; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FHitResult OutHit; // (Parm, OutParm, IsPlainOldData)
	TArray<struct FVector> OutPathPositions; // (Parm, OutParm, ZeroConstructor)
	...
	struct FVector LaunchVelocity; // (Parm, IsPlainOldData)
	bool bTracePath; // (Parm, ZeroConstructor, IsPlainOldData)
	float BulletRadius; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ECollisionChannel> TraceChannel; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bTraceComplex; // (Parm, ZeroConstructor, IsPlainOldData)
	TArray<class AActor*> ActorsToIgnore; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TEnumAsByte<enum EDrawDebugTrace> DrawDebugType; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UGameplayStatics_ApplyRadialDamageWithFalloff_Params
{
	...
	TEnumAsByte<enum ECollisionChannel> DamagePreventionChannel; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.InstancedStaticMeshComponent.ShowInstances
struct UInstancedStaticMeshComponent_ShowInstances_Params
{
...
// Function Engine.InstancedStaticMeshComponent.ResetAllInstances
struct UInstancedStaticMeshComponent_ResetAllInstances_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedStaticMeshComponent.ReplaceAllInstances
struct UInstancedStaticMeshComponent_ReplaceAllInstances_Params
{
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
// Function Engine.InstancedStaticMeshComponent.HideInstance
struct UInstancedStaticMeshComponent_HideInstance_Params
{
	TArray<int> InstanceIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.HierarchicalInstancedStaticMeshComponent.ShowInstances
struct UHierarchicalInstancedStaticMeshComponent_ShowInstances_Params
{
	TArray<int> InstanceIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Engine.HierarchicalInstancedStaticMeshComponent.ResetAllInstances
struct UHierarchicalInstancedStaticMeshComponent_ResetAllInstances_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct APlayerController_SetViewTargetWithBlend_Params
{
	...
	TEnumAsByte<enum EViewTargetBlendFunction> BlendFunc; // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	TEnumAsByte<enum EMouseCursor> Cursor; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct APlayerController_PlayDynamicForceFeedback_Params
{
	...
	TEnumAsByte<enum EDynamicForceFeedbackAction> Action; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FLatentActionInfo LatentInfo; // (Parm)
};
...
// Function Engine.PlayerController.OnGoingToLoseJoystick
struct APlayerController_OnGoingToLoseJoystick_Params
{
};
...
{
	TEnumAsByte<enum EControllerAnalogStick> WhichStick; // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	TEnumAsByte<enum ETouchIndex> FingerIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ETraceTypeQuery> TraceChannel; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bTraceComplex; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FHitResult HitResult; // (Parm, OutParm, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
{
	struct FString URL; // (Parm, ZeroConstructor)
	TEnumAsByte<enum ETravelType> TravelType; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct APlayerController_ClientPlayCameraShake_Params
{
	class UClass* Shake; // (Parm, ZeroConstructor, IsPlainOldData)
	float Scale; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ECameraAnimPlaySpace> PlaySpace; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct APlayerController_ClientPlayCameraAnim_Params
{
	...
	TEnumAsByte<enum ECameraAnimPlaySpace> Space; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.PlayerController.ClearJoystick
struct APlayerController_ClearJoystick_Params
{
};
...
// Function Engine.HUD.UpdateShowDebugTargetActor
struct AHUD_UpdateShowDebugTargetActor_Params
{
	class AActor* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.HUD.ShowDebugForMoifiedTargetActor
struct AHUD_ShowDebugForMoifiedTargetActor_Params
{
};
...
struct AHUD_DrawTexture_Params
{
	...
	TEnumAsByte<enum EBlendMode> BlendMode; // (Parm, ZeroConstructor, IsPlainOldData)
	float Scale; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bScalePosition; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UNavigationSystem_GetPathLength_Params
{
	...
	class ANavigationData* NavData; // (Parm, ZeroConstructor, IsPlainOldData)
	class UClass* FilterClass; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ENavigationQueryResult> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.AnimNotify_PlayParticleEffect.OnParticleSystemFinished
struct UAnimNotify_PlayParticleEffect_OnParticleSystemFinished_Params
{
	class UParticleSystemComponent* FinishedComponent; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
};

// Function Engine.AnimNotify_PlayParticleEffect.GetParentCharacter
struct UAnimNotify_PlayParticleEffect_GetParentCharacter_Params
{
	class USkeletalMeshComponent* MeshComp; // (Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	class ACharacter* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
{
	TEnumAsByte<enum ESplineMeshAxis> InForwardAxis; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bUpdateMesh; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum ESplineMeshAxis> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UInstancedSplineMeshComponent_UpdateMesh_Params
{
};

// Function Engine.InstancedSplineMeshComponent.ShowOrHideIndex
struct UInstancedSplineMeshComponent_ShowOrHideIndex_Params
{
...
// Function Engine.InstancedSplineMeshComponent.SetStaticMeshPrepation
struct UInstancedSplineMeshComponent_SetStaticMeshPrepation_Params
{
};

// Function Engine.InstancedSplineMeshComponent.SetSplineUpDir
struct UInstancedSplineMeshComponent_SetSplineUpDir_Params
{
	struct FVector InSplineUpDir; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	bool bUpdateMesh; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UInstancedSplineMeshComponent_SetForwardAxis_Params
{
	TEnumAsByte<enum ESplineMeshAxis> InForwardAxis; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bUpdateMesh; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UInstancedSplineMeshComponent_SetBoundaryMin_Params
{
	float InBoundaryMin; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bUpdateMesh; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UInstancedSplineMeshComponent_SetBoundaryMax_Params
{
	float InBoundaryMax; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bUpdateMesh; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.ResetLocalBounds
struct UInstancedSplineMeshComponent_ResetLocalBounds_Params
{
};

// Function Engine.InstancedSplineMeshComponent.IsInstanceHide
struct UInstancedSplineMeshComponent_IsInstanceHide_Params
{
	int InstanceIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.GetStartTangent
struct UInstancedSplineMeshComponent_GetStartTangent_Params
{
	int InstanceIndex; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.GetStartPosition
struct UInstancedSplineMeshComponent_GetStartPosition_Params
{
	int InstanceIndex; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
struct UInstancedSplineMeshComponent_GetSplineUpDir_Params
{
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.GetInstanceNum
struct UInstancedSplineMeshComponent_GetInstanceNum_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.GetForwardAxis
struct UInstancedSplineMeshComponent_GetForwardAxis_Params
{
	TEnumAsByte<enum ESplineMeshAxis> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.GetEndTangent
struct UInstancedSplineMeshComponent_GetEndTangent_Params
{
	int InstanceIndex; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.GetEndPosition
struct UInstancedSplineMeshComponent_GetEndPosition_Params
{
	int InstanceIndex; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
struct UInstancedSplineMeshComponent_GetBoundaryMin_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.GetBoundaryMax
struct UInstancedSplineMeshComponent_GetBoundaryMax_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.ClearIndex
struct UInstancedSplineMeshComponent_ClearIndex_Params
{
	int Index; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	bool bUpdateMesh; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.InstancedSplineMeshComponent.AddOrSetIndexStartAndEnd
struct UInstancedSplineMeshComponent_AddOrSetIndexStartAndEnd_Params
{
	int Index; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
struct UMaterialInterface_SetStreamingTextureMipOffset_Params
{
	...
	bool SizeLimited; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.MaterialInterface.RefreshTextureMipmapImmediately
struct UMaterialInterface_RefreshTextureMipmapImmediately_Params
{
};
...
// Function Engine.CameraActor.SetSequencePrimitiveTrackingEnabled
struct ACameraActor_SetSequencePrimitiveTrackingEnabled_Params
{
	bool bEnabled; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.CameraActor.SetFullScreen
struct ACameraActor_SetFullScreen_Params
{
	bool bNewFullScreen; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.AnimInstanceContainerInterface.OnDeactived
struct UAnimInstanceContainerInterface_OnDeactived_Params
{
};

// Function Engine.AnimInstanceContainerInterface.OnActived
struct UAnimInstanceContainerInterface_OnActived_Params
{
};

// Function Engine.AnimInstanceContainer.SetTargetAnimInstance
struct UAnimInstanceContainer_SetTargetAnimInstance_Params
{
	class UClass* InstanceClass; // (Parm, ZeroConstructor, IsPlainOldData)
	class UAnimInstance* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimInstanceContainer.SetSoftTargetAnimInstance
struct UAnimInstanceContainer_SetSoftTargetAnimInstance_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimInstanceContainer.RemoveCacheAnimInstance
struct UAnimInstanceContainer_RemoveCacheAnimInstance_Params
{
	class UClass* InstanceClass; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimInstanceContainer.IsRunningTargetAnimInstance
struct UAnimInstanceContainer_IsRunningTargetAnimInstance_Params
{
	class UClass* InstanceClass; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimInstanceContainer.IsReceiveInPoseNode
struct UAnimInstanceContainer_IsReceiveInPoseNode_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimInstanceContainer.GetTargetInstance
struct UAnimInstanceContainer_GetTargetInstance_Params
{
	bool bCheckPendingKill; // (Parm, ZeroConstructor, IsPlainOldData)
	class UAnimInstance* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimInstanceContainer.ClearCacheAnimInstance
struct UAnimInstanceContainer_ClearCacheAnimInstance_Params
{
};

// Function Engine.AnimInstanceContainer.AddCacheAnimInstance
struct UAnimInstanceContainer_AddCacheAnimInstance_Params
{
	class UClass* InstanceClass; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.ReflectionCaptureComponent.SetRealtimeColor
struct UReflectionCaptureComponent_SetRealtimeColor_Params
{
	struct FVector InColor; // (Parm, IsPlainOldData)
};

// Function Engine.ReflectionCaptureComponent.SetRealtimeBrightness
struct UReflectionCaptureComponent_SetRealtimeBrightness_Params
{
	float InBrightness; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.ReflectionCaptureComponent.SetRealtimeAngle
struct UReflectionCaptureComponent_SetRealtimeAngle_Params
{
...
// Function Engine.CameraAnimInst.SetCurrentTime
struct UCameraAnimInst_SetCurrentTime_Params
{
...
// Function Engine.Texture.Blueprint_ChangeMaxTextureSize
struct UTexture_Blueprint_ChangeMaxTextureSize_Params
{
...
// Function Engine.CheatManager.TriggerCrash
struct UCheatManager_TriggerCrash_Params
{
};
...
// Function Engine.GameViewportClient.RemoveViewportChangeDelegate
struct UGameViewportClient_RemoveViewportChangeDelegate_Params
{
	struct FScriptDelegate Delegate; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
};

// Function Engine.GameViewportClient.AddViewportChangeDelegate
struct UGameViewportClient_AddViewportChangeDelegate_Params
{
	struct FScriptDelegate Delegate; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
};
...
struct UDataTableFunctionLibrary_EvaluateCurveTableRow_Params
{
	...
	TEnumAsByte<enum EEvaluateCurveTableResult> OutResult; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.DecalBakingParameterComponent.GetUVScaleBias
struct UDecalBakingParameterComponent_GetUVScaleBias_Params
{
	struct FLinearColor ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Engine.DecalBakingParameterComponent.GetDecalBounds
struct UDecalBakingParameterComponent_GetDecalBounds_Params
{
	struct FBoxSphereBounds ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Engine.DecalBakingParameterComponent.GetCropUVScaleBias
struct UDecalBakingParameterComponent_GetCropUVScaleBias_Params
{
	struct FLinearColor ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
// Function Engine.LightComponent.SetLightPriority
struct ULightComponent_SetLightPriority_Params
{
	int Priority; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.LightComponent.ForceUpdateShadowState
struct ULightComponent_ForceUpdateShadowState_Params
{
};
...
// Function Engine.DirectionalLightComponent.SetCloudShadowWinSpeed
struct UDirectionalLightComponent_SetCloudShadowWinSpeed_Params
{
	struct FVector2D InWinSpeed; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};

// Function Engine.DirectionalLightComponent.SetCloudShadowTileSize
struct UDirectionalLightComponent_SetCloudShadowTileSize_Params
{
	float InValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DirectionalLightComponent.SetCloudShadowTexture
struct UDirectionalLightComponent_SetCloudShadowTexture_Params
{
	class UTexture* InTexture; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DirectionalLightComponent.SetCloudShadowDensity
struct UDirectionalLightComponent_SetCloudShadowDensity_Params
{
	float InDensity; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DirectionalLightComponent.SetCastsCloudShadow
struct UDirectionalLightComponent_SetCastsCloudShadow_Params
{
	bool InValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DirectionalLightComponent.SetCastPhotonShadow
struct UDirectionalLightComponent_SetCastPhotonShadow_Params
{
	bool InValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.DirectionalLightComponent.SetCastPhotonPerObjectShadow
struct UDirectionalLightComponent_SetCastPhotonPerObjectShadow_Params
{
	bool InValue; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.ExponentialHeightFogComponent.SetVolumetricFogStartDistance
struct UExponentialHeightFogComponent_SetVolumetricFogStartDistance_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.ExponentialHeightFogComponent.SetVolumetricFogNoiseTransform
struct UExponentialHeightFogComponent_SetVolumetricFogNoiseTransform_Params
{
	struct FTransform Transform; // (Parm, IsPlainOldData)
};

// Function Engine.ExponentialHeightFogComponent.SetVolumetricFogNoiseTexture
struct UExponentialHeightFogComponent_SetVolumetricFogNoiseTexture_Params
{
	class UTexture2D* NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.ExponentialHeightFogComponent.SetDirectionalInscatteringGapControl
struct UExponentialHeightFogComponent_SetDirectionalInscatteringGapControl_Params
{
	float Value; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum EWindowMode> InFullscreenMode; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum EWindowMode> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.HeterogeneousVolumeComponent.SetVolumeResolution
struct UHeterogeneousVolumeComponent_SetVolumeResolution_Params
{
	struct FIntVector NewValue; // (Parm, IsPlainOldData)
};

// Function Engine.HeterogeneousVolumeComponent.SetStreamingMipBias
struct UHeterogeneousVolumeComponent_SetStreamingMipBias_Params
{
	int NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.HeterogeneousVolumeComponent.SetStartFrame
struct UHeterogeneousVolumeComponent_SetStartFrame_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.HeterogeneousVolumeComponent.SetPlaying
struct UHeterogeneousVolumeComponent_SetPlaying_Params
{
	bool NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.HeterogeneousVolumeComponent.SetLooping
struct UHeterogeneousVolumeComponent_SetLooping_Params
{
	bool NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.HeterogeneousVolumeComponent.SetFrameRate
struct UHeterogeneousVolumeComponent_SetFrameRate_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.HeterogeneousVolumeComponent.SetFrame
struct UHeterogeneousVolumeComponent_SetFrame_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.HeterogeneousVolumeComponent.SetEndFrame
struct UHeterogeneousVolumeComponent_SetEndFrame_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.HeterogeneousVolumeComponent.Play
struct UHeterogeneousVolumeComponent_Play_Params
{
};

// Function Engine.ColorInstancedStaticMeshComponent.UpdateInstanceTransformWithColor
struct UColorInstancedStaticMeshComponent_UpdateInstanceTransformWithColor_Params
{
	int InstanceIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FTransform NewInstanceTransform; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
...
// Function Engine.ColorInstancedStaticMeshComponent.ShowInstancesWithColor
struct UColorInstancedStaticMeshComponent_ShowInstancesWithColor_Params
{
	TArray<int> InstanceIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FColor> InstanceColors; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ColorInstancedStaticMeshComponent.ShowInstances
struct UColorInstancedStaticMeshComponent_ShowInstances_Params
{
	TArray<int> InstanceIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Engine.ColorInstancedStaticMeshComponent.ReplaceAllInstancesWithColor
struct UColorInstancedStaticMeshComponent_ReplaceAllInstancesWithColor_Params
{
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FColor> InstanceColors; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bShouldReturnIndices; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.ColorInstancedStaticMeshComponent.ReplaceAllInstances
struct UColorInstancedStaticMeshComponent_ReplaceAllInstances_Params
{
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bShouldReturnIndices; // (Parm, ZeroConstructor, IsPlainOldData)
	TArray<int> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
...
// Function Engine.ColorInstancedStaticMeshComponent.RemoveInstances
struct UColorInstancedStaticMeshComponent_RemoveInstances_Params
{
	TArray<int> InstanceIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ColorInstancedStaticMeshComponent.RemoveInstance
struct UColorInstancedStaticMeshComponent_RemoveInstance_Params
{
	int InstanceIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ColorInstancedStaticMeshComponent.HideInstance
struct UColorInstancedStaticMeshComponent_HideInstance_Params
{
	TArray<int> InstanceIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ColorInstancedStaticMeshComponent.ClearInstances
struct UColorInstancedStaticMeshComponent_ClearInstances_Params
{
};

// Function Engine.ColorInstancedStaticMeshComponent.AddInstanceWorldSpace
struct UColorInstancedStaticMeshComponent_AddInstanceWorldSpace_Params
{
	struct FTransform WorldTransform; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ColorInstancedStaticMeshComponent.AddInstancesWithColor
struct UColorInstancedStaticMeshComponent_AddInstancesWithColor_Params
{
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FColor> InstanceColors; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bShouldReturnIndices; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.ColorInstancedStaticMeshComponent.AddInstances
struct UColorInstancedStaticMeshComponent_AddInstances_Params
{
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bShouldReturnIndices; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bMarkRenderStateDirty; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.ColorInstancedStaticMeshComponent.AddInstance
struct UColorInstancedStaticMeshComponent_AddInstance_Params
{
	struct FTransform InstanceTransform; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ColorHierarchicalInstancedStaticMeshComponent.ShowInstancesWithColor
struct UColorHierarchicalInstancedStaticMeshComponent_ShowInstancesWithColor_Params
{
	TArray<int> InstanceIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FColor> InstanceColors; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
// Function Engine.ColorHierarchicalInstancedStaticMeshComponent.ShowInstances
struct UColorHierarchicalInstancedStaticMeshComponent_ShowInstances_Params
{
	TArray<int> InstanceIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// Function Engine.ColorHierarchicalInstancedStaticMeshComponent.RemoveInstances
struct UColorHierarchicalInstancedStaticMeshComponent_RemoveInstances_Params
{
	TArray<int> InstancesToRemove; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ColorHierarchicalInstancedStaticMeshComponent.AddInstancesWithColor
struct UColorHierarchicalInstancedStaticMeshComponent_AddInstancesWithColor_Params
{
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FColor> InstanceColors; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bShouldReturnIndices; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UImportanceSamplingLibrary_MakeImportanceTexture_Params
{
	...
	TEnumAsByte<enum EImportanceWeight> WeightingFunc; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UImportanceSamplingLibrary_BreakImportanceTexture_Params
{
	...
	TEnumAsByte<enum EImportanceWeight> WeightingFunc; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};
...
struct UKismetMathLibrary_VEase_Params
{
	...
	struct FVector B; // (Parm, IsPlainOldData)
	float Alpha; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EEasingFunc> EasingFunc; // (Parm, ZeroConstructor, IsPlainOldData)
	float BlendExp; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UKismetMathLibrary_TLerp_Params
{
	...
	float Alpha; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ELerpInterpolationMode> InterpMode; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FTransform ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
struct UKismetRenderingLibrary_RenderTargetCreateStaticTexture2DEditorOnly_Params
{
	...
	TEnumAsByte<enum ETextureCompressionSettings> CompressionSettings; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ETextureMipGenSettings> MipSettings; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UKismetRenderingLibrary_CreateRenderTarget2D_Params
{
	...
	int Width; // (Parm, ZeroConstructor, IsPlainOldData)
	int Height; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ETextureRenderTargetFormat> Format; // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UKismetStringLibrary_StartsWith_Params
{
	...
	TEnumAsByte<enum ESearchCase> SearchCase; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct UKismetStringLibrary_Split_Params
{
	...
	TEnumAsByte<enum ESearchCase> SearchCase; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ESearchDir> SearchDir; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.KismetSystemLibrary.RedirectSoftObjectPaths
struct UKismetSystemLibrary_RedirectSoftObjectPaths_Params
{
	TArray<struct FSoftObjectPath> Paths; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
struct UKismetSystemLibrary_QuitGame_Params
{
	class UObject* WorldContextObject; // (Parm, ZeroConstructor, IsPlainOldData)
	class APlayerController* SpecificPlayer; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum EQuitPreference> QuitPreference; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.KismetSystemLibrary.PrintShippingString
struct UKismetSystemLibrary_PrintShippingString_Params
{
	class UObject* WorldContextObject; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FString inString; // (Parm, ZeroConstructor)
	bool bPrintToScreen; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.KismetSystemLibrary.GetUxCode
struct UKismetSystemLibrary_GetUxCode_Params
{
	struct FString ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};
...
// Function Engine.KismetSystemLibrary.GetRedirectedPackageName
struct UKismetSystemLibrary_GetRedirectedPackageName_Params
{
	struct FString Path; // (Parm, ZeroConstructor)
	bool bInFilePath; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FName ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.KismetSystemLibrary.GetRedirectedFilePathString
struct UKismetSystemLibrary_GetRedirectedFilePathString_Params
{
	struct FString Path; // (Parm, ZeroConstructor)
	bool bInFilePath; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bReplaceExt; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FString ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function Engine.KismetSystemLibrary.GetRedirectedAssetPathString
struct UKismetSystemLibrary_GetRedirectedAssetPathString_Params
{
	struct FString Path; // (Parm, ZeroConstructor)
	bool bInFilePath; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FString ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
...
// Function Engine.KismetSystemLibrary.GetConsoleVariableValue
struct UKismetSystemLibrary_GetConsoleVariableValue_Params
{
...
// Function Engine.KismetSystemLibrary.GetClassPathName
struct UKismetSystemLibrary_GetClassPathName_Params
{
	class UObject* Object; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FString ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function Engine.KismetSystemLibrary.GetClassName
struct UKismetSystemLibrary_GetClassName_Params
{
	class UObject* Object; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
	struct FString ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};
...
// Function Engine.KismetSystemLibrary.GetBUoCode
struct UKismetSystemLibrary_GetBUoCode_Params
{
	TArray<struct FString> SxArray; // (Parm, OutParm, ZeroConstructor)
};

// Function Engine.KismetSystemLibrary.GetAUxCode
struct UKismetSystemLibrary_GetAUxCode_Params
{
	struct FString ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function Engine.KismetSystemLibrary.GetAUoCode
struct UKismetSystemLibrary_GetAUoCode_Params
{
	TArray<struct FString> SxArray; // (Parm, OutParm, ZeroConstructor)
};
...
// Function Engine.KismetSystemLibrary.DelayForFrames
struct UKismetSystemLibrary_DelayForFrames_Params
{
	class UObject* WorldContextObject; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.KismetSystemLibrary.ClearPkgRedirectMap
struct UKismetSystemLibrary_ClearPkgRedirectMap_Params
{
};
...
{
	float Value; // (Parm, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ERoundingMode> RoundingMode; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bUseGrouping; // (Parm, ZeroConstructor, IsPlainOldData)
	int MinimumIntegralDigits; // (Parm, ZeroConstructor, IsPlainOldData)
	int MaximumIntegralDigits; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.LevelStreaming.SetDisableByReason
struct ULevelStreaming_SetDisableByReason_Params
{
	ELevelDisableReason Reason; // (Parm, ZeroConstructor, IsPlainOldData)
...
// Function Engine.LevelStreaming.HasDisableFlag
struct ULevelStreaming_HasDisableFlag_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.LiteComponent.SetIsReplicated
struct ULiteComponent_SetIsReplicated_Params
{
	bool ShouldReplicate; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.LiteComponent.ReceiveTick
struct ULiteComponent_ReceiveTick_Params
{
	float DeltaSeconds; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.LiteComponent.ReceivePostBeginPlay
struct ULiteComponent_ReceivePostBeginPlay_Params
{
};

// Function Engine.LiteComponent.ReceiveEndPlay
struct ULiteComponent_ReceiveEndPlay_Params
{
};

// Function Engine.LiteComponent.ReceiveBeginPlay
struct ULiteComponent_ReceiveBeginPlay_Params
{
};

// Function Engine.LiteComponent.IsDedicatedServer
struct ULiteComponent_IsDedicatedServer_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.LiteComponent.HasAuthority
struct ULiteComponent_HasAuthority_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.LiteComponent.GetOwner
struct ULiteComponent_GetOwner_Params
{
	class UObject* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
{
	struct FName ParameterName; // (Parm, ZeroConstructor, IsPlainOldData)
	class USparseVolumeTexture* Value; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum ENavigationOptionFlag> DoRecalculation; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.NetObjectPathNameMappingManager.OnMappingTableAsyncLoad
struct UNetObjectPathNameMappingManager_OnMappingTableAsyncLoad_Params
{
	struct FSoftObjectPath MappingTableObj; // (Parm)
};

// Function Engine.NewObjectPoolSystem.SwitcherCheckByClassType
struct UNewObjectPoolSystem_SwitcherCheckByClassType_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.SwitcherCheck
struct UNewObjectPoolSystem_SwitcherCheck_Params
{
	struct FObjectPoolConfig PoolConfig; // (Parm, OutParm, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.RemoveFence
struct UNewObjectPoolSystem_RemoveFence_Params
{
	EObjectPoolFenceType FenceType; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FName FenceName; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.Remove
struct UNewObjectPoolSystem_Remove_Params
{
};

// Function Engine.NewObjectPoolSystem.Recycle
struct UNewObjectPoolSystem_Recycle_Params
{
	class UObject* RecycleObject; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.IsAvailableChildClass
struct UNewObjectPoolSystem_IsAvailableChildClass_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.GetInited
struct UNewObjectPoolSystem_GetInited_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.ExistingFences
struct UNewObjectPoolSystem_ExistingFences_Params
{
	EObjectPoolFenceType FenceType; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.CreateFence
struct UNewObjectPoolSystem_CreateFence_Params
{
	EObjectPoolFenceType FenceType; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FName FenceName; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.ClearAll
struct UNewObjectPoolSystem_ClearAll_Params
{
	bool CollectGarbage; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.Clear
struct UNewObjectPoolSystem_Clear_Params
{
	bool CollectGarbage; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.NewObjectPoolSystem.AddDefault
struct UNewObjectPoolSystem_AddDefault_Params
{
};

// Function Engine.NewObjectPoolSystem.Add
struct UNewObjectPoolSystem_Add_Params
{
	struct FObjectPoolConfig PoolConfig; // (Parm, OutParm, ReferenceParm)
};

// Function Engine.ObjectPoolInterface.UseUnLimitObjectPool
struct UObjectPoolInterface_UseUnLimitObjectPool_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ObjectPoolInterface.ResetPropsNormally
struct UObjectPoolInterface_ResetPropsNormally_Params
{
	class UObject* CDO; // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.ObjectPoolInterface.ReceiveOnRespawned
struct UObjectPoolInterface_ReceiveOnRespawned_Params
{
};

// Function Engine.ObjectPoolInterface.ReceiveOnRecycled
struct UObjectPoolInterface_ReceiveOnRecycled_Params
{
};

// Function Engine.ObjectPoolInterface.ReceiveOnNetRespawned
struct UObjectPoolInterface_ReceiveOnNetRespawned_Params
{
};
...
// Function Engine.ObjectPoolInterface.OnNetRespawned
struct UObjectPoolInterface_OnNetRespawned_Params
{
};

// Function Engine.ObjectPoolInterface.GetUnLimitObjectPoolSize
struct UObjectPoolInterface_GetUnLimitObjectPoolSize_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ObjectPoolInterface.GetUnLimitObjectPoolLifePeriodTime
struct UObjectPoolInterface_GetUnLimitObjectPoolLifePeriodTime_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ObjectPoolInterface.GetDynamicRecyclePoolSize
struct UObjectPoolInterface_GetDynamicRecyclePoolSize_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ObjectPoolInterface.EnableDynamicRecycle
struct UObjectPoolInterface_EnableDynamicRecycle_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ObjectPoolInterface.CheckIsRespawned
struct UObjectPoolInterface_CheckIsRespawned_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ObjectPoolInterface.CheckIsRecycled
struct UObjectPoolInterface_CheckIsRecycled_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.OceanFFTComponent.Update
struct UOceanFFTComponent_Update_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.ParallelWorldSubsystem.AddWorlds
struct UParallelWorldSubsystem_AddWorlds_Params
{
	TArray<int> InWorldIds; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.ParticleSystem.GetBounds
struct UParticleSystem_GetBounds_Params
{
	struct FBoxSphereBounds ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Engine.ParticleSystem.GetBoundingBox
struct UParticleSystem_GetBoundingBox_Params
{
	struct FBox ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
{
	TEnumAsByte<enum ELinearConstraintMotion> ConstraintType; // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	TEnumAsByte<enum EConstraintFrame> Frame; // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	TEnumAsByte<enum EAngularConstraintMotion> ConstraintType; // (Parm, ZeroConstructor, IsPlainOldData)
	float TwistLimitAngle; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum EAngularConstraintMotion> MotionType; // (Parm, ZeroConstructor, IsPlainOldData)
	float Swing2LimitAngle; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum EAngularDriveMode> DriveMode; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.PhysicsConstraintComponent.GetConstraintWorldTransform
struct UPhysicsConstraintComponent_GetConstraintWorldTransform_Params
{
	TEnumAsByte<enum EConstraintFrame> Frame; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FTransform ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
// Function Engine.PixelProjectedReflection.OnInterpToggle
struct APixelProjectedReflection_OnInterpToggle_Params
{
	bool bEnable; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.PointLightComponent.SetSimulateRectLight
struct UPointLightComponent_SetSimulateRectLight_Params
{
	bool NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PointLightComponent.SetSimulatePortalLight
struct UPointLightComponent_SetSimulatePortalLight_Params
{
	bool NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PointLightComponent.SetRectLightSourceWidth
struct UPointLightComponent_SetRectLightSourceWidth_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.PointLightComponent.SetRectLightSourceHeight
struct UPointLightComponent_SetRectLightSourceHeight_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UPoseableMeshComponent_SetBoneTransformByName_Params
{
	struct FName BoneName; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FTransform InTransform; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	TEnumAsByte<enum EBoneSpaces> BoneSpace; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct APostProcessVolume_RemoveBlendable_Params
{
	TScriptInterface<class UBlendableInterface> InBlendableObject; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum EObjectTypeQuery> ObjectType; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.ResetableInReplayInterface.ResetInReplay
struct UResetableInReplayInterface_ResetInReplay_Params
{
};

// Function Engine.Reusable.ReceiveOnSpawn
struct UReusable_ReceiveOnSpawn_Params
{
};

// Function Engine.Reusable.ReceiveOnRecycle
struct UReusable_ReceiveOnRecycle_Params
{
};

// Function Engine.Reusable.ReceiveOnPoolCreate
struct UReusable_ReceiveOnPoolCreate_Params
{
};

// Function Engine.Reusable.OnSpawn
struct UReusable_OnSpawn_Params
{
};

// Function Engine.Reusable.OnRecycle
struct UReusable_OnRecycle_Params
{
};
...
// Function Engine.SkeletalMesh.RestoreSpecificLOD
struct USkeletalMesh_RestoreSpecificLOD_Params
{
	int LODIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	ELODDropResult ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkeletalMesh.RestoreAllDroppedLODs
struct USkeletalMesh_RestoreAllDroppedLODs_Params
{
};
...
// Function Engine.SkeletalMesh.IsLODDropped
struct USkeletalMesh_IsLODDropped_Params
{
	int LODIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkeletalMesh.HasPendingDropRelease
struct USkeletalMesh_HasPendingDropRelease_Params
{
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.SkeletalMesh.GetLODVRAMFootprint
struct USkeletalMesh_GetLODVRAMFootprint_Params
{
	int LODIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.SkeletalMesh.GetDroppedLODs
struct USkeletalMesh_GetDroppedLODs_Params
{
	TArray<int> ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm)
};
...
// Function Engine.SkeletalMesh.DropSpecificLOD
struct USkeletalMesh_DropSpecificLOD_Params
{
	int LODIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	ELODDropResult ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SkeletalMesh.DropLODs
struct USkeletalMesh_DropLODs_Params
{
	TArray<int> LODIndices; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<ELODDropResult> OutResults; // (Parm, OutParm, ZeroConstructor)
};

// Function Engine.SkeletalMesh.CommitPendingDropReleases
struct USkeletalMesh_CommitPendingDropReleases_Params
{
};
...
struct USkyAtmosphereComponent_OverrideAtmosphereLightDirection_Params
{
	...
	struct FVector LightDirection; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};
...
// Function Engine.SparseVolumeTexture.GetSizeZ
struct USparseVolumeTexture_GetSizeZ_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SparseVolumeTexture.GetSizeY
struct USparseVolumeTexture_GetSizeY_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SparseVolumeTexture.GetSizeX
struct USparseVolumeTexture_GetSizeX_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SparseVolumeTexture.GetNumMipLevels
struct USparseVolumeTexture_GetNumMipLevels_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SparseVolumeTexture.GetNumFrames
struct USparseVolumeTexture_GetNumFrames_Params
{
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SparseVolumeTexture.GetFrameTransform
struct USparseVolumeTexture_GetFrameTransform_Params
{
	struct FTransform ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimatedSparseVolumeTextureController.Update
struct UAnimatedSparseVolumeTextureController_Update_Params
{
	float DeltaTime; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.AnimatedSparseVolumeTextureController.Stop
struct UAnimatedSparseVolumeTextureController_Stop_Params
{
};

// Function Engine.AnimatedSparseVolumeTextureController.Play
struct UAnimatedSparseVolumeTextureController_Play_Params
{
};

// Function Engine.AnimatedSparseVolumeTextureController.Pause
struct UAnimatedSparseVolumeTextureController_Pause_Params
{
};

// Function Engine.AnimatedSparseVolumeTextureController.GetFrameByIndex
struct UAnimatedSparseVolumeTextureController_GetFrameByIndex_Params
{
	int FrameIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	class USparseVolumeTextureFrame* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimatedSparseVolumeTextureController.GetFractionalFrameIndex
struct UAnimatedSparseVolumeTextureController_GetFractionalFrameIndex_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimatedSparseVolumeTextureController.GetDuration
struct UAnimatedSparseVolumeTextureController_GetDuration_Params
{
	float ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.AnimatedSparseVolumeTextureController.GetCurrentFramesForInterpolation
struct UAnimatedSparseVolumeTextureController_GetCurrentFramesForInterpolation_Params
{
	class USparseVolumeTextureFrame* Frame0; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
	class USparseVolumeTextureFrame* Frame1; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
	float LerpAlpha; // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.AnimatedSparseVolumeTextureController.GetCurrentFrame
struct UAnimatedSparseVolumeTextureController_GetCurrentFrame_Params
{
	class USparseVolumeTextureFrame* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.SplineComponentEditorModifer.ModifyPostion
struct USplineComponentEditorModifer_ModifyPostion_Params
{
	struct FVector InPosition; // (Parm, IsPlainOldData)
	struct FVector ReturnValue; // (Parm, OutParm, ReturnParm, IsPlainOldData)
};
...
// Function Engine.StaticMesh.RemoveVertexColors
struct UStaticMesh_RemoveVertexColors_Params
{
};

// Function Engine.StaticMesh.RemoveTextureCoord
struct UStaticMesh_RemoveTextureCoord_Params
{
	int ReserveTexCoordNum; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StaticMesh.GetNumVertices
struct UStaticMesh_GetNumVertices_Params
{
	int LODIndex; // (Parm, ZeroConstructor, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
// Function Engine.StatLabelFunctionLibrary.StatStop
struct UStatLabelFunctionLibrary_StatStop_Params
{
};

// Function Engine.StatLabelFunctionLibrary.StatStart
struct UStatLabelFunctionLibrary_StatStart_Params
{
	bool IsScreenshotEnabled; // (Parm, ZeroConstructor, IsPlainOldData)
	bool IsStatLogEnabled; // (Parm, ZeroConstructor, IsPlainOldData)
	bool IsStatLabelEnabled; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.StatLabelFunctionLibrary.SetStatLabel
struct UStatLabelFunctionLibrary_SetStatLabel_Params
{
...
{
	TEnumAsByte<enum EVerticalTextAligment> Value; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TEnumAsByte<enum EHorizTextAligment> Value; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.TextureArrayInstancedStaticMeshComponent.SetStaticMesh
struct UTextureArrayInstancedStaticMeshComponent_SetStaticMesh_Params
{
	class UStaticMesh* NewMesh; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.TextureArrayInstancedStaticMeshComponent.AddInstanceWithTextureArray
struct UTextureArrayInstancedStaticMeshComponent_AddInstanceWithTextureArray_Params
{
	class UMaterialInstance* NewInstance; // (Parm, ZeroConstructor, IsPlainOldData)
	struct FTransform InstanceTransform; // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
	int ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.TextureArrayInstancedStaticMeshComponent.AddInstancesWithTextureArray
struct UTextureArrayInstancedStaticMeshComponent_AddInstancesWithTextureArray_Params
{
	class UMaterialInstance* NewInstance; // (Parm, ZeroConstructor, IsPlainOldData)
	TArray<struct FTransform> InstanceTransforms; // (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
	bool bShouldReturnIndices; // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	TEnumAsByte<enum ETimelineLengthMode> NewLengthMode; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UTwitterIntegrationBase_TwitterRequest_Params
{
	...
	TEnumAsByte<enum ETwitterRequestMethod> RequestMethod; // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	class UMaterialInterface* NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};
...
// Function Engine.VolumetricCloudComponent.SetBoxMin
struct UVolumetricCloudComponent_SetBoxMin_Params
{
	struct FVector NewValue; // (Parm, IsPlainOldData)
};

// Function Engine.VolumetricCloudComponent.SetBoxMax
struct UVolumetricCloudComponent_SetBoxMax_Params
{
	struct FVector NewValue; // (Parm, IsPlainOldData)
};

// Function Engine.VolumetricFogBoxComponent.SetVolumetricFogExtinctionScale
struct UVolumetricFogBoxComponent_SetVolumetricFogExtinctionScale_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.VolumetricFogBoxComponent.SetVolumetricFogEmissive
struct UVolumetricFogBoxComponent_SetVolumetricFogEmissive_Params
{
	struct FLinearColor NewValue; // (Parm, IsPlainOldData)
};

// Function Engine.VolumetricFogBoxComponent.SetVolumetricFogAlbedo
struct UVolumetricFogBoxComponent_SetVolumetricFogAlbedo_Params
{
	struct FColor NewValue; // (Parm, IsPlainOldData)
};

// Function Engine.VolumetricFogSphereComponent.SetVolumetricFogExtinctionScale
struct UVolumetricFogSphereComponent_SetVolumetricFogExtinctionScale_Params
{
	float NewValue; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.VolumetricFogSphereComponent.SetVolumetricFogEmissive
struct UVolumetricFogSphereComponent_SetVolumetricFogEmissive_Params
{
	struct FLinearColor NewValue; // (Parm, IsPlainOldData)
};

// Function Engine.VolumetricFogSphereComponent.SetVolumetricFogAlbedo
struct UVolumetricFogSphereComponent_SetVolumetricFogAlbedo_Params
{
	struct FColor NewValue; // (Parm, IsPlainOldData)
};
...
// Function Engine.WorldComposition.SetStreamingDistanceScalePerLevel
struct UWorldComposition_SetStreamingDistanceScalePerLevel_Params
{
...
// Function Engine.WorldComposition.SetStreamingDistanceScaleByLayer
struct UWorldComposition_SetStreamingDistanceScaleByLayer_Params
{
	struct FString LayerName; // (Parm, ZeroConstructor)
	float Scale; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.WorldComposition.SetStreamingDistanceScaleAllLevel
struct UWorldComposition_SetStreamingDistanceScaleAllLevel_Params
{
	float Scale; // (Parm, ZeroConstructor, IsPlainOldData)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.WorldComposition.RemoveDynamicTile
struct UWorldComposition_RemoveDynamicTile_Params
{
	struct FString TilePackageNameStr; // (Parm, ZeroConstructor)
	bool ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.WorldComposition.GetDynamicTile
struct UWorldComposition_GetDynamicTile_Params
{
	struct FString TilePackageNameStr; // (Parm, ZeroConstructor)
	class ULevelStreaming* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.WorldComposition.AddEnableStreamingTile
struct UWorldComposition_AddEnableStreamingTile_Params
{
	int EnableTileIdx; // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.WorldComposition.AddEnableStreamingLayer
struct UWorldComposition_AddEnableStreamingLayer_Params
{
	struct FString EnableLayerName; // (Parm, ZeroConstructor)
};

// Function Engine.WorldComposition.AddDynamicTile
struct UWorldComposition_AddDynamicTile_Params
{
	struct FString TilePackageNameStr; // (Parm, ZeroConstructor)
	int X; // (Parm, ZeroConstructor, IsPlainOldData)
	int Y; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bAllowCopy; // (Parm, ZeroConstructor, IsPlainOldData)
	bool bDisableDistanceStreaming; // (Parm, ZeroConstructor, IsPlainOldData)
	class ULevelStreaming* ReturnValue; // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
