...
public:
	...
	TEnumAsByte<enum ETextJustify> Justification; // 0x01C4(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<enum ETextVerticalJustify> TextVerticalJustification; // 0x01C5(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	void SetTextJustification(TEnumAsByte<enum ETextJustify> InJustification);
